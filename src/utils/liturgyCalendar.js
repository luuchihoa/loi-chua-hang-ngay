...
function getMovableFeast(d, ms) {
  const pairs = [
    ...
    [ms.tat_nien,            "tat_nien",          "Thánh lễ Tất Niên", 7],
    [ms.giao_thua,           "giao_thua",         "Thánh lễ Giao Thừa - Cầu bình an cho Năm Mới", 7],
    [ms.tet_1,               "tet_1",             "Mồng Một Tết Nguyên Đán: Thánh lễ Tân Niên", 5],
    [ms.tet_2,               "tet_2",             "Mồng Hai Tết Nguyên Đán: Kính nhớ Tổ tiên", 5],
    [ms.tet_3,               "tet_3",             "Mồng Ba Tết Nguyên Đán: Thánh hóa công ăn việc làm", 5],
