...
export default function LiturgyPage() {
  ...
  // Kiến trúc: Fixed In-Flow Indent Box (Cố định w-10 sm:w-12, 100% thẳng hàng từng pixel)
      ...
      while (i < rawLines.length) {
        ...
        if (chapterVerseMatch) {
          ...
          if (singleVerseMatch) {
            ...
            // TH3: Đầu dòng KHÔNG có số câu -> Thẻ inline-flex rỗng cố định w-10 sm:w-12
