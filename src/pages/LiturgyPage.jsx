...
import { 
  ...
  Maximize2, Minimize2, Search, X, Command, Tag, Bookmark
} from 'lucide-react';
                ...
                <div ref={pickerRef} className="relative flex justify-center w-full sm:w-auto lg:w-full">
                  <div className={`h-[46px] flex items-center bg-white/90 dark:bg-stone-900/90 backdrop-blur-md rounded-2xl border ${theme.navBg} px-1 shadow-sm w-full sm:w-auto lg:w-full justify-between sm:justify-start`}>
                    ...
                    <button
                      ...
                      className="px-2 sm:px-3 flex flex-col items-center justify-center min-w-[160px] sm:w-[200px] lg:w-auto lg:flex-1 rounded-xl hover:bg-stone-100/60 dark:hover:bg-stone-800/60 transition-colors py-0.5 cursor-pointer active:scale-95"
                    >
