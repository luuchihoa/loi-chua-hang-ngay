...
[SECTION] Bết
(2) Tỉ ti nàng khóc suốt đêm dài,
...
Con than thở đã quá nhiều rồi, và tim con héo hắt.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'ac', 2, '[PART] BÀI THỨ HAI
[SECTION] A-lép
...
Đức Chúa hủy diệt chẳng chút xót thương;
nổi trận lôi đình, Người triệt hạ
đồn lũy của thiếu nữ Giu-đa;
...
Người đốt lên trong Gia-cóp như ngọn hỏa hào
...
[SECTION] Hê
(5) Chúa nên như địch thủ, hủy diệt Ít-ra-en,
hủy diệt mọi lâu đài dinh thự, triệt hạ các lũy đồn của nó;
...
nay địch quân giết chết cả rồi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'ac', 3, '[PART] BÀI THỨ BA
[SECTION] A-lép
(1) Tôi là người đã sống cảnh lầm than
...
hành hạ tôi đủ cách.
[SECTION] Bết
(4) Da thịt tôi, Người khiến phải hao mòn,
...
[SECTION] Ghi-men
(7) Người xây tường vây kín lấy tôi, tôi không sao trốn thoát.
...
[SECTION] Vau
(16) Răng tôi, Người bắt nhai đá sỏi,
...
[SECTION] Khết
(22) Lượng từ bi ĐỨC CHÚA đâu đã cạn,
...
[SECTION] Giốt
(28) Khi chính Chúa bắt nó phải mang,
...
[SECTION] Mêm
(37) Ai chỉ nói một lời là có mọi sự?
...
[SECTION] Xa-méc
(43) Ngài ẩn mình trong cơn thịnh nộ,
...
[SECTION] Xa-đê
(52) Những người thù ghét tôi vô cớ
...
[SECTION] Cốp
(55) Từ hố sâu, thân lạy ĐỨC CHÚA,
...
[SECTION] Rết
(58) Ngài biện hộ cho con, lạy Chúa,
...
[SECTION] Sin
(61) Lạy ĐỨC CHÚA, Ngài đã nghe những lời lăng nhục,
...
[SECTION] Tau
(64) Lạy ĐỨC CHÚA, xin Ngài đáp trả
tùy theo những việc tay chúng làm.
...
cho chúng khuất dạng khỏi gầm trời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'ac', 4, '[PART] BÀI THỨ TƯ
[SECTION] A-lép
(1) Làm sao vàng lại phai nhạt được?
Vàng tinh khiết nhất cũng biến chất rồi!
Đá thánh nằm vung vãi mọi đầu đường góc phố.
[SECTION] Bết
(2) Những người con ưu tú của Xi-on quý giá tựa vàng ròng,
sao lại bị coi thường như bình đất
do tay người thợ gốm làm ra?
[SECTION] Ghi-men
(3) Ngay cả lũ chó rừng cũng biết chìa vú cho con bú,
thế mà con gái dân tôi lại dữ dằn hung bạo
như đà điểu chốn hoang địa khô cằn.
[SECTION] Đa-lét
(4) Bé thơ măng sữa, vì quá khát, nên lưỡi dính với hàm;
...
[SECTION] Da-in
(7) Đám thanh niên mới ngày nao rạng ngời hơn tuyết,
...
[SECTION] Mêm
(13) Âu cũng chỉ vì ngôn sứ tội lỗi,
...
[SECTION] Sin
(21) Hãy vui lên, hãy nhảy mừng, hỡi thiếu nữ Ê-đôm
đang cư ngụ trong miền đất Út:
chén lôi đình rồi cũng đến lượt ngươi phải uống,
say ngất say ngư, ngươi sẽ tự lột trần.
[SECTION] Tau
(22) Hỡi thiếu nữ Xi-on, tội vạ ngươi đã được tẩy xóa,
ngươi chẳng còn phải đi lưu đày nữa.
Còn ngươi, hỡi thiếu nữ Ê-đôm,
sự gian ác của ngươi, Người sẽ trừng trị,
tội lỗi của ngươi, Người sẽ lột trần.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'ac', 5, '[PART] BÀI THỨ NĂM
...
đã giận chúng con hết mức rồi?') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;