...
thì đáng thuộc quyền sở hữu của nó.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 2, '(1) Thật vậy, suy tính sai lầm, chúng bảo nhau:
...
tư tưởng lóe lên từ nhịp đập trái tim.
...
những đóa hoa xuân, ta đừng bỏ phí.
...
[SECTION] Sai lầm của phường vô đạo
...
Những ai về phe nó đều phải nếm mùi cái chết.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 3, '[SECTION] Số phận của những người công chính và của phường vô đạo
...
[SECTION] Thà không con còn hơn có dòng dõi vô đạo
...
chung cục của giống nòi bất chính!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 4, '(1) Chẳng thà không con cái mà sống đời đức hạnh!
...
[SECTION] Người công chính chết yểu
...
Người đánh bật chúng đi, hủy diệt chúng đến cùng.
Và chúng sẽ phải chịu nhiều thống khổ,
chẳng còn ai thèm nhớ đến chúng.
[SECTION] Quân vô đạo trước tòa phán xét
(20) Chúng sẽ phải kinh hãi ra tính sổ tội mình.
Những tội ác chúng phạm sẽ cáo buộc chúng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 5, '(1) Bấy giờ người công chính đứng dậy thật hiên ngang
...
[SECTION] Người công chính được vinh quang, quân vô đạo chịu hình phạt
...
vì những việc đồi bại mà lũ quyền uy sẽ bị lật khỏi ngai báu.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 6, '[PART] II. VUA SA-LÔ-MÔN VÀ VIỆC TÌM KIẾM ĐỨC KHÔN NGOAN
[SECTION] Bậc vua chúa phải tìm kiếm Đức Khôn Ngoan
...
[SECTION] Đức Khôn Ngoan gặp gỡ con người
...
[SECTION] Vua Sa-lô-môn miêu tả Đức Khôn Ngoan
...
mà hưởng phần ích lợi nơi lời lẽ của tôi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 7, '[SECTION] Vua Sa-lô-môn cũng chỉ là phàm nhân
...
[SECTION] Vua Sa-lô-môn ca ngợi Đức Khôn Ngoan
...
(10) Tôi đã ham chuộng Đức Khôn Ngoan hơn sức khỏe và sắc đẹp,
...
[SECTION] Kêu xin Thiên Chúa soi sáng
...
(18) thấu hiểu về thời gian từ khởi thủy, qua các thời đại,
...
[SECTION] Ca tụng Đức Khôn Ngoan
...
(25) Đức Khôn Ngoan tỏa ra từ quyền năng Thiên Chúa
...
biến họ nên bạn hữu của Thiên Chúa, nên ngôn sứ của Người.
...
Còn Đức Khôn Ngoan, chẳng gian tà nào thắng nổi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 8, '(1) Từ chân trời này,
Đức Khôn Ngoan vươn mạnh tới chân trời kia,
cai quản mọi loài thật tốt đẹp.
[SECTION] Đức Khôn Ngoan, hiền thê lý tưởng
(2) Từ thời trai trẻ,
...
(7) Con người mến chuộng đức công bằng ư?
...
[SECTION] Vua chúa cần có Đức Khôn Ngoan
...
[SECTION] Vua Sa-lô-môn xin cho được Đức Khôn Ngoan
...
nên tôi hướng về Đức Chúa và cầu nguyện, tôi hết lòng thưa lên:') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 9, '[SECTION] Lời cầu xin cho được Đức Khôn Ngoan
...
và nhờ Đức Khôn Ngoan mà được cứu độ.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 10, '[PART] III. ĐỨC KHÔN NGOAN HOẠT ĐỘNG TRONG LỊCH SỬ
[SECTION] Từ ông A-đam tới ông Mô-sê
...
và cho lưỡi trẻ thơ nói năng dễ dàng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 11, '(1) Nhờ tay ngôn sứ thánh,
...
[SECTION] Chúa nhẹ tay với dân Ai-cập
...
[SECTION] Lý do khiến Chúa nương tay
...
vì mọi loài đều là của Chúa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 12, '(1) Quả vậy, lạy Đức Chúa, sinh khí bất diệt của Ngài
...
[SECTION] Chúa nhẹ tay với Ca-na-an
...
Và ai dám cáo tội Ngài hủy diệt dân nước Ngài đã lập nên?
...
[SECTION] Những bài học Chúa dạy cho Ít-ra-en
...
[SECTION] Lại nói về hình phạt Ai-cập
...
Và vì thế, án quyết cuối cùng ập xuống trên chúng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 13, '[SECTION] Kết án tội thờ ngẫu tượng
...
(5) Vì các thụ tạo càng lớn lao đẹp đẽ
...
đem nấu nướng thức ăn, rồi anh ăn thỏa thích.
...
Với vật yếu đuối, anh xin sức khỏe;
...
(19) với vật không nhích nổi đôi tay, anh xin cho mình nhiều sức lực,
cho việc tay mình làm được mỹ mãn thành công.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 14, '(1) Một người khác chuẩn bị ra khơi, vượt sóng to gió lớn,
...
(11) Bởi thế, Thiên Chúa sẽ trừng trị hết mọi tượng thần của chư dân,
...
[SECTION] Nguồn gốc việc tôn thờ ngẫu tượng
...
thì từ xa đã họa lại dung nhan,
...
dù họ đã nhân danh các thần mà thề hứa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 15, '[SECTION] Ít-ra-en không thờ ngẫu tượng
...
những công trình vô bổ của các nhà họa sĩ,
những hình ảnh lem luốc với màu sắc lòe loẹt,
...
[SECTION] Điên rồ thay ai làm ra ngẫu tượng
...
(13) Thật ra, hơn bất cứ một người nào khác,
anh ta biết rõ mình phạm tội
khi dùng đất cát làm ra cả bình dễ vỡ lẫn tượng thần.
[SECTION] Người Ai-cập điên rồ khi thờ ngẫu tượng khắp nơi
...
hay phúc lành của Thiên Chúa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 16, '[SECTION] Ví dụ thứ hai: cóc nhái
...
Họ thèm thuồng khao khát, Ngài cho được thỏa mãn,
...
[SECTION] Ví dụ thứ ba: châu chấu và rắn đồng
...
[SECTION] Ví dụ thứ bốn: mưa đá và man-na
...
(18) Vì có lúc ngọn lửa dịu đi, không thiêu hủy
...
thiêu hủy mọi hoa màu trên miền đất vô đạo.
...
bánh có muôn hương vị, thỏa mãn mọi sở thích.
...
là nhằm phá hủy hoa màu của thù địch.
(23) Ngược lại, lửa đã quên đi sức mạnh của mình
để người công chính còn có thức ăn.
(24) Quả thế, loài thụ tạo tuân phục Ngài là Tạo Hóa
khi thẳng tay trừng phạt bọn bất lương,
nhưng lại nương tay
nhằm mưu ích cho những ai tin tưởng vào Ngài.
(25) Vì vậy, cũng lúc đó, thụ tạo sẵn sàng biến đổi mọi thứ
...
(27) Vì những gì không bị lửa đốt cháy tiêu tan
lại tan chảy dưới vài tia nắng ấm,
...
trôi đi như dòng nước vô dụng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 17, '[SECTION] Ví dụ thứ năm: bóng tối và cột lửa
...
bị loại khỏi sự quan phòng vĩnh cửu.
...
(8) Vì những người hứa với bệnh nhân sẽ xua trừ sợ hãi và bối rối
...
bị lương tâm giày vò, nó luôn cảm thấy mình khổ sở.
...
(14) Trong đêm thật sự bất lực này,
...
Nhưng chính chúng còn nặng nề hơn cả bóng tối nữa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 18, '(1) Trong khi đó, một ánh sáng vĩ đại
chiếu tỏa trên dân thánh của Ngài.
...
[SECTION] Ví dụ thứ sáu: đêm thảm sầu và đêm giải thoát
(5) Vì chúng đã quyết định sát hại các trẻ sơ sinh của dân thánh,
duy một trẻ nhỏ bị bỏ rơi đã được cứu thoát,
thì để trừng phạt chúng, Ngài đã lấy đi
vô vàn vô số trẻ thơ của chúng,
và tiêu diệt bọn chúng hết thảy trong nước lũ hung tàn.
...
(18) Chúng bị quăng nửa sống nửa chết, đứa chỗ này đứa chỗ kia.
...
[SECTION] Đe dọa bị tận diệt trong sa mạc
...
ông chấm dứt họa tai khi chứng tỏ mình là tôi tớ Chúa.
...
vì cho nếm cơn thịnh nộ một chút thôi là đủ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'kn', 19, '[SECTION] Ví dụ thứ bảy: Biển Đỏ
...
(12) Để làm họ thỏa lòng, chim cút từ ngoài biển bay lên chỗ họ.
[SECTION] Ai-cập đắc tội hơn Xơ-đôm
...
(14) Quả vậy, có những kẻ đã không tiếp rước
...
(17) Vì thế, chúng sẽ phải chịu cảnh mù lòa
...
[SECTION] Hòa điệu mới
(18) Như thế, các nguyên tố khác biệt lại hòa hợp với nhau
...
Và mọi nơi mọi thời, Ngài đã không ngừng nâng đỡ họ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;