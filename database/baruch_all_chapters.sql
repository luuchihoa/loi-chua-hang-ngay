INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'br', 1, '[PART] NHẬP ĐỀ
[SECTION] Ông Ba-rúc và cộng đồng Do-thái ở Ba-by-lon
...
(15) Nhưng ai tìm thấy nơi cư ngụ,
...
và đã sống giữa loài người.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'br', 4, '(1) Đức khôn ngoan
...
[PART] III. GIÊ-RU-SA-LEM THAN VAN VÀ HY VỌNG
...
(12) Chớ ai vui mừng vì thấy tôi góa bụa, bị mọi người bỏ rơi;
...
hân hoan vì được vinh quang Thiên Chúa ở cùng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'br', 5, '(1) Hỡi Giê-ru-sa-lem, hãy cởi bỏ áo tang khổ nhục,
