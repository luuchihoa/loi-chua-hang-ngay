...
[SECTION] Điều kiện thứ nhất: đoạn tuyệt với tội lỗi
...
và lời của Người không ở trong chúng ta.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, '1ga', 2, '(1) Hỡi anh em là những người con bé nhỏ của tôi,
...
[SECTION] Điều kiện thứ hai: tuân giữ các điều răn, nhất là điều răn bác ái
...
nơi kẻ ấy tình yêu Thiên Chúa đã thật sự nên hoàn hảo.
...
[SECTION] Điều kiện thứ ba: coi chừng thế gian
(12) Hỡi anh em là những người con bé nhỏ, tôi viết cho anh em:
...
thì tồn tại mãi mãi.
[SECTION] Điều kiện thứ bốn: đề phòng những kẻ Phản Ki-tô
(18) Hỡi anh em là những người con thơ bé, đây là giờ cuối cùng.
...
(24) Phần anh em,
ước chi điều anh em đã nghe từ lúc khởi đầu ở lại trong anh em.
Nếu điều anh em đã nghe từ lúc khởi đầu ở lại trong anh em,
thì chính anh em sẽ ở lại trong Chúa Con và Chúa Cha.
(25) Và đây là điều mà chính Đức Ki-tô đã hứa ban cho chúng ta:
sự sống đời đời.
...
[PART] II. SỐNG XỨNG ĐÁNG LÀ CON CÁI THIÊN CHÚA
(29) Nếu anh em biết Thiên Chúa là Đấng Công Chính,
anh em cũng phải biết rằng: phàm ai sống công chính
thì đã được Thiên Chúa sinh ra.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, '1ga', 3, '(1) Anh em hãy xem Chúa Cha yêu chúng ta dường nào:
Người yêu đến nỗi
...
để xóa bỏ tội lỗi, và nơi Người không có tội lỗi.
...
đó là nhờ Thần Khí,
Thần Khí Người đã ban cho chúng ta.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, '1ga', 4, '[SECTION] Điều kiện thứ ba: đề phòng thế gian và những ngôn sứ giả
...
[PART] III. NGUỒN MẠCH ĐỨC ÁI VÀ ĐỨC TIN
[SECTION] Nguồn mạch đức ái
...
ai yêu mến Thiên Chúa, thì cũng yêu thương anh em mình.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, '1ga', 5, '(1) Phàm ai tin rằng Đức Giê-su là Đấng Ki-tô,
...
[PART] BỔ TÚC
[SECTION] Cầu nguyện cho người tội lỗi
...
hãy tránh xa các tà thần!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;