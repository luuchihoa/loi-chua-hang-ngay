...
còn đường lối ác nhân đưa tới chỗ diệt vong.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 2, '[SECTION] Đấng Mê-si-a là Vua chiến thắng
...
thật hạnh phúc dường bao!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 3, '[SECTION] ĐỨC CHÚA là Đấng bảo vệ người công chính
...
xin ban phúc lộc cho dân Ngài.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 4, '[SECTION] Lời tạ ơn
(1) Phần ca trưởng. Có họa đàn. Thánh vịnh. Của vua Đa-vít.
...
ban cho con được sống yên hàn.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 5, '[SECTION] Lời kinh sáng xin ĐỨC CHÚA bảo vệ
(1) Phần ca trưởng. Có thổi quyển. Thánh vịnh. Của vua Đa-vít.
...
lấy ân tình bao phủ như thuẫn đỡ khiên che.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 6, '[SECTION] Người gặp thử thách van nài ĐỨC CHÚA thương
(1) Phần ca trưởng. Có họa đàn. Theo đàn bát huyền. Thánh vịnh. Của vua Đa-vít.
...
vội tháo lui, nhục nhã ê chề.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 7, '[SECTION] Bị vu oan, người công chính kêu cầu Thiên Chúa
...
(17) Hại người chẳng hóa hại thân,
gậy ông đập xuống lại dần lưng ông.
(18) Tôi xin tạ ơn CHÚA, bởi vì Người công minh chính trực,
tôi đàn ca mừng danh CHÚA Tối Cao.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 8, '[SECTION] Oai phong ĐỨC CHÚA và phẩm giá con người
(1) Phần ca trưởng. Có họa đàn thành Gát. Thánh vịnh. Của vua Đa-vít.
...
lẫy lừng thay danh Chúa trên khắp cả địa cầu!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 9, '[SECTION] (9A) Tạ ơn ĐỨC CHÚA sau khi chiến thắng
(1) Phần ca trưởng. Theo điệu: מות לבן (muth labbén). Thánh vịnh. Của vua Đa-vít.
[SECTION] A-lép
...
(5) Chúa là vị thẩm phán chí công, Ngài ngự tòa xét xử,
bênh vực và bảo vệ quyền lợi con.
[SECTION] Ghi-men
(6) Ngài hăm dọa chư dân, tiêu diệt lũ gian tà,
tên tuổi chúng, cũng xóa đi vĩnh viễn.
...
chư dân phải nhận biết: mình chỉ là phàm nhân.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 10, '[SECTION] (9B) Lời kinh tạ ơn
[SECTION] La-mét
...
khiến cho kẻ mang thân cát bụi, chẳng còn khủng bố ai.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 11, '[SECTION] (10) ĐỨC CHÚA là Đấng kẻ lành tin tưởng
(1) Phần ca trưởng. Của vua Đa-vít.
...
được chiêm ngưỡng Thánh Nhan.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 12, '[SECTION] (11) Chống lại các kẻ chỉ nói những lời gian dối
(1) Phần ca trưởng. Họa đàn bát huyền. Thánh vịnh. Của vua Đa-vít.
...
chuyện đê hèn đầy dẫy nhân gian.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 13, '[SECTION] (12) Lời kêu than của người lành tin cậy vào ĐỨC CHÚA
...
Con sẽ hát bài ca dâng CHÚA, vì phúc lộc Ngài ban.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 14, '[SECTION] (13) Người không tin vào Thiên Chúa
(1) Phần ca trưởng. Của vua Đa-vít.
...
dân Ít-ra-en hớn hở dường bao!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 15, '[SECTION] (14) Ai được vào ngụ trong nhà Chúa?
...
không hề nao núng chuyển lay bao giờ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 16, '[SECTION] (15) ĐỨC CHÚA là phần gia nghiệp
...
ở bên Ngài, hoan lạc chẳng hề vơi!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 17, '[SECTION] (16) Cầu xin ĐỨC CHÚA cứu khỏi ác nhân
...
cả đàn con cũng được ăn thỏa thích,
phần còn lại, cho bầy cháu mai sau.
(15) Về phần con, sống công minh chính trực,
con sẽ được trông thấy mặt Ngài,
khi thức giấc, được thỏa tình chiêm ngưỡng Thánh Nhan.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 18, '[SECTION] (17) Vua tạ ơn ĐỨC CHÚA cứu độ đã ban chiến thắng
(1) Phần ca trưởng. Của tôi tớ ĐỨC CHÚA là vua Đa-vít. Ông nói lên lời bài ca này vào ngày ĐỨC CHÚA đã cứu ông khỏi bàn tay các địch thù và khỏi tay vua Sa-un.
(2) Con yêu mến Ngài, lạy CHÚA là sức mạnh của con;
(3) lạy CHÚA là núi đá, là thành lũy, là Đấng giải thoát con;
...
từ trong đồn lũy, run rẩy kéo nhau ra.
...
là Đa-vít cùng dòng dõi đến muôn đời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 19, '[SECTION] (18) Ca tụng ĐỨC CHÚA, Đấng tạo thành vũ trụ và ban hành luật pháp
(1) Phần ca trưởng. Thánh vịnh. Của vua Đa-vít.
...
mong được thấu đến Ngài.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 20, '[SECTION] (19) Xin ĐỨC CHÚA ban cho vua chiến thắng
(1) Phần ca trưởng. Thánh vịnh. Của vua Đa-vít.
...
ngày chúng con cầu khẩn, nguyện xin Chúa đáp lời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 21, '[SECTION] (20) Tạ ơn ĐỨC CHÚA đã ban cho vua nhiều ân huệ
(1) Phần ca trưởng. Thánh vịnh. Của vua Đa-vít.
...
chúng con sẽ đàn ca chúc tụng quyền năng Chúa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 22, '[SECTION] (21) Gặp đau khổ, người lành cầu cứu, và ĐỨC CHÚA đã nhậm lời
(1) Phần ca trưởng. Theo điệu: Con nai hừng đông. Thánh vịnh. Của vua Đa-vít.
...
(27) Kẻ nghèo hèn được ăn uống thỏa thuê,
...
rằng: “Đức Chúa đã làm như vậy!”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 23, '[SECTION] (22) Mục tử nhân hậu
(1) Thánh vịnh. Của vua Đa-vít.
...
những ngày tháng, những năm dài triền miên.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 24, '[SECTION] (23) ĐỨC CHÚA ngự vào đền thánh
(1) Thánh vịnh. Của vua Đa-vít.
...
Là Chúa Tể càn khôn: chính Người là Đức Vua vinh hiển.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 25, '[SECTION] (24) Xin ơn thứ tha và cứu thoát
(1) Của vua Đa-vít.
[SECTION] A-lép
...
[SECTION] Xa-đê
(17) Lòng đau như thắt, xin làm cho thanh thỏa,
...
thoát mọi nỗi truân chuyên ngặt nghèo.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 26, '[SECTION] (25) Người vô tội tin tưởng cầu nguyện
(1) Của vua Đa-vít.
...
(10) Tay chúng gây tội ác tày trời,
...
giữa lòng đại hội, con xin chúc tụng Ngài.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 27, '[SECTION] (26) Tin tưởng và cậy trông vào ĐỨC CHÚA khi gặp gian nguy
(1) Của vua Đa-vít.
...
Hãy cậy trông vào CHÚA.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 28, '[SECTION] (27) Lời cầu khẩn và tạ ơn
(1) Của vua Đa-vít.
...
(5) Vì chúng chẳng quan tâm đến việc CHÚA làm,
...
dẫn dắt nâng niu đến muôn đời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 29, '[SECTION] (28) Tiếng Chúa trong cơn phong ba bão táp
(1) Thánh vịnh. Của vua Đa-vít.
...
tuôn đổ phúc lành cho dân hưởng bình an.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 30, '[SECTION] (29) Tạ ơn ĐỨC CHÚA đã cứu khỏi chết
...
xin tạ ơn Ngài mãi mãi ngàn thu.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 31, '[SECTION] (30) Lời cầu nguyện tin tưởng của người gặp thử thách
(1) Phần ca trưởng. Thánh vịnh. Của vua Đa-vít.
...
(17) Xin tỏa ánh tôn nhan rạng ngời
...
mạnh bạo lên, can đảm lên nào!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 32, '[SECTION] (31) Hạnh phúc thay kẻ lỗi lầm mà được tha thứ
...
Mọi tâm hồn ngay thẳng, nào cất tiếng hò reo.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 33, '[SECTION] (32) Ca ngợi ĐỨC CHÚA là Đấng toàn năng, biết hết mọi sự và là Đấng cứu độ duy nhất
...
như chúng con hằng trông cậy nơi Ngài.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 34, '[SECTION] (33) ĐỨC CHÚA là nơi người lành ẩn náu
...
[SECTION] Xa-méc
(15) hãy làm lành lánh dữ, tìm kiếm bình an, ăn ở thuận hòa.
[SECTION] Pê
...
ai ẩn thân bên Chúa không bị phạt bao giờ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 35, '[SECTION] (34) Cầu xin ĐỨC CHÚA cứu trong cơn nguy
(1) Của vua Đa-vít.
...
(16) Chúng khiêu khích tôi và nặng lời chế nhạo,
...
(20) Vì chúng chẳng nói đến hòa bình,
...
và suốt ngày, con sẽ ca ngợi tán dương.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 36, '[SECTION] (35) Ác nhân thì độc dữ, còn ĐỨC CHÚA thì nhân từ
(1) Phần ca trưởng. Của tôi tớ ĐỨC CHÚA. Của vua Đa-vít.
...
ngã quỵ rồi, không trỗi dậy nổi đâu.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 37, '[SECTION] (36) Số phận người lành kẻ dữ
(1) Của vua Đa-vít.
[SECTION] A-lép
...
không để bị kết án khi phải ra trước tòa.
[SECTION] Cốp
...
bởi vì họ ẩn náu bên Người.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 38, '[SECTION] (37) Lời cầu khẩn của tội nhân lâm cơn cùng khốn
...
(23) Lạy Chúa cứu độ con, xin Ngài mau phù trợ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 39, '[SECTION] (38) Trong kiếp sống phù du, người đau yếu đặt hy vọng nơi ĐỨC CHÚA và xin Người đến cứu giúp
...
(14) Xin ngoảnh mặt đi cho lòng con thanh thỏa,
trước lúc thân này phải ra đi và không còn nữa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 40, '[SECTION] (39) Cảm tạ ĐỨC CHÚA và xin Người phù giúp
(1) Phần ca trưởng. Của vua Đa-vít. Thánh vịnh.
...
(13) Tai họa bủa vây con hằng hà sa số,
...
lạy Thiên Chúa con thờ, xin đừng trì hoãn!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 41, '[SECTION] (40) Lời cầu của bệnh nhân
(1) Phần ca trưởng. Thánh vịnh. Của vua Đa-vít.
...
từ muôn thuở cho đến muôn đời. A-men. A-men.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 42, '[SECTION] (41) Quy hướng về Thiên Chúa và Đền Thánh
(1) Phần ca trưởng. Thi khúc. Của con cái ông Cô-rắc.
...
xót xa phận mình mãi làm chi?
Hãy cậy trông Thiên Chúa, tôi còn tán tụng Người,
Người là Đấng cứu độ, là Thiên Chúa của tôi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 43, '[SECTION] (42)
...
INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 44, '[SECTION] (43) Các tai họa Dân Thiên Chúa mắc phải
(1) Phần ca trưởng. Của con cái ông Cô-rắc. Thi khúc.
...
(17) Nghe thóa mạ, nghe lộng ngôn kêu réo,
...
(25) Sao Ngài còn ẩn mặt, quên rằng chúng con bị khổ cực đọa đày?
(26) Mạng chúng con chôn vùi trong cát bụi,
tấm thân này nằm bẹp dưới bùn đen.
(27) Dám xin Ngài đứng lên phù giúp,
lấy tình thương cứu chuộc dân Ngài.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 45, '[SECTION] (44) Bài ca mừng hôn lễ Quân Vương
(1) Phần ca trưởng. Theo điệu: Những bông huệ. Của con cái ông Cô-rắc. Thi khúc. Tình ca.
...
(9) Quế trầm mộc dược, hương tỏa long bào,
...
tiếng ngợi ca bất tận muôn đời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 46, '[SECTION] (45) Thiên Chúa là nơi ẩn náu và sức mạnh của người tín hữu
(1) Phần ca trưởng. Của con cái ông Cô-rắc. Theo điệu: Các thiếu nữ. Thánh ca.
...
(10) Người chấm dứt chiến tranh trên toàn cõi thế,
...
Thiên Chúa nhà Gia-cóp là thành bảo vệ ta.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 47, '[SECTION] (46) Thiên Chúa là Vua khắp hoàn vũ
(1) Phần ca trưởng. Của con cái ông Cô-rắc. Thánh vịnh.
(2) Vỗ tay đi nào, muôn dân hỡi!
Mừng Thiên Chúa, hãy cất tiếng hò reo!
(3) Vì ĐỨC CHÚA là Đấng Tối Cao, Đấng khả úy,
...
Đấng siêu việt ngàn trùng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 48, '[SECTION] (47) Thiên Chúa, Đấng giải thoát và bảo vệ Xi-on
...
Thiên Chúa tỏ ra chính Người là thành lũy.
...
(13) Hãy đi vòng Xi-on, dọc theo tường lũy,
...
Người lãnh đạo chúng ta đến muôn thuở.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 49, '[SECTION] (48) Của đời phù vân
(1) Phần ca trưởng. Của con cái ông Cô-rắc. Thánh vịnh.
...
thật nó chẳng khác chi
con vật một ngày kia phải chết.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 50, '[SECTION] (49) Thế nào là có lòng đạo đức thật
...
Ai sống đời hoàn hảo, Ta cho hưởng ơn cứu độ Chúa Trời.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 51, '[SECTION] (50) Lạy Thiên Chúa, xin xót thương con
(1) Phần ca trưởng. Thánh vịnh. Của vua Đa-vít. (2) Ngôn sứ Na-than đến gặp vua vì vua đã đến với bà Bát Se-va.
...
Bấy giờ thiên hạ giết bò tơ dâng trên bàn thờ Chúa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 52, '[SECTION] (51) Chống lại người miệng lưỡi hiểm độc
(1) Phần ca trưởng. Thi khúc. Của vua Đa-vít. (2) Khi Đô-ếch, người Ê-đôm, đến báo cho vua Sa-un rằng: “Đa-vít đến gặp ông A-khi-me-léc!”
...
con trông đợi danh Ngài, vì danh Ngài thiện hảo.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 53, '[SECTION] (52) Người không tin vào Thiên Chúa
...
INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 54, '[SECTION] (53) Xin ơn phù giúp
...
và con đã dám nghênh bọn địch thù.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 55, '[SECTION] (54) Than phiền vì địch thù hung dữ, vì bạn bất trung
...
(9) Tôi sẽ vội tìm nơi ẩn trú, tránh khỏi cơn dông tố bão bùng.”
...
Phần con đây con tin tưởng nơi Ngài.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 56, '[SECTION] (55) Tin tưởng vào Thiên Chúa
...
để con bước đi trước mặt Ngài trong ánh sáng dành cho kẻ sống.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 57, '[SECTION] (56) Ẩn náu bên Thiên Chúa
(1) Phần ca trưởng. “Xin đừng phá đổ”. Của vua Đa-vít. Se sẽ. Khi ông chạy vào hang, trốn vua Sa-un.
(2) Xin thương xót con cùng, lạy Thiên Chúa,
...
và chiếu tỏa vinh quang đầy mặt đất.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 58, '[SECTION] (57) Có thực các người phán quyết công minh?
(1) Phần ca trưởng. “Xin đừng phá đổ”. Của vua Đa-vít. Se sẽ.
...
quả thật có Thiên Chúa xét xử trên địa cầu.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 59, '[SECTION] (58) Xin ơn đối phó với kẻ thù
(1) Phần ca trưởng. “Xin đừng phá đổ.” Của vua Đa-vít. Se sẽ. Khi vua Sa-un sai người canh giữ nhà ông để hãm hại ông.
(2) Lạy Thiên Chúa của con, xin cứu con khỏi lũ địch thù,
...
bởi con được Chúa nên đồn nên lũy,
chốn con nương mình trong buổi gian truân.
(18) Lạy Chúa là sức mạnh của con, xin đàn hát mừng Ngài,
bởi Ngài là thành lũy bảo vệ con,
lạy Thiên Chúa, Đấng đầy lòng yêu mến.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 60, '[SECTION] (59) Lời cầu nguyện sau khi bại trận
(1) Phần ca trưởng. Theo điệu: Bông huệ chứng ước. Se sẽ. Của vua Đa-vít. Để dạy. (2) Khi ông đánh dân A-ram Na-ha-ra-gim và A-ram Xô-va, và khi ông Giô-áp trở lại đánh thắng Ê-đôm trong thung lũng Muối: mười hai ngàn người.
...
chính Người chà đạp kẻ thù ta.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 61, '[SECTION] (60) Người lưu vong cầu nguyện
(1) Phần ca trưởng. Theo huyền cầm. Của vua Đa-vít.
...
(9) Bấy giờ con mãi mãi đàn ca mừng Danh Thánh,
ngày lại ngày, xin giữ trọn lời nguyền.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 62, '[SECTION] (61) Tin tưởng vào Thiên Chúa
...
rằng: Ngài theo tội phúc mà thưởng phạt mỗi người.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 63, '[SECTION] (62) Tâm hồn khao khát Thiên Chúa
...
còn người nói dối phải câm miệng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 64, '[SECTION] (63) Cầu xin Thiên Chúa giúp đối phó với kẻ thù
(1) Phần ca trưởng. Thánh vịnh. Của vua Đa-vít.
...
và ẩn náu bên Người.
Mọi tấm lòng chính trực đều lấy thế làm vinh.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 65, '[SECTION] (64) Lời tạ ơn long trọng
(1) Phần ca trưởng. Thánh vịnh. Của vua Đa-vít. Thánh ca.
(2) Lạy Thiên Chúa,
...
câu hò tiếng hát trổi cao.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 66, '[SECTION] (65) Ca khúc tạ ơn
(1) Phần ca trưởng. Thánh ca. Thánh vịnh.
...
(6) Chúa làm cho biển khơi hóa đất liền,
...
lại cũng không dứt nghĩa đoạn tình.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 67, '[SECTION] (66) Muôn dân nước hãy cảm tạ Thiên Chúa
(1) Phần ca trưởng. Theo huyền cầm. Thánh vịnh. Thánh ca.
...
Ước chi toàn cõi đất kính sợ Người!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 68, '[SECTION] (67) Thiên Chúa chiến thắng khải hoàn
...
Người là Đấng khả tôn khả úy.
Chính Người là Thiên Chúa Ít-ra-en,
Đấng ban tặng cho dân dũng lực uy quyền.
Xin chúc tụng Thiên Chúa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 69, '[SECTION] (68) Vì nhiệt tâm lo việc nhà Chúa, mà con phải thiệt thân
(1) Phần ca trưởng. Theo điệu: Những bông huệ. Của vua Đa-vít.
(2) Lạy Chúa Trời, xin cứu vớt con,
...
(11) Con nhịn ăn đến tiều tụy thân hình,
...
(21) Lời thóa mạ làm tim này tan vỡ, con héo hắt rã rời.
...
(29) Ước gì chúng bị xóa tên trong sổ trường sinh,
...
của những người mến chuộng Thánh Danh.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 70, '[SECTION] (69) Lạy Chúa Trời, xin đến cứu con
(1) Phần ca trưởng. Của vua Đa-vít. Để tưởng nhớ.
...
Ngài là Đấng phù trợ, là Đấng giải thoát con,
muôn lạy CHÚA, xin đừng trì hoãn.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 71, '[SECTION] (70) Từ độ thanh xuân, tôi trông cậy Chúa
...
Vì những kẻ tìm cách gây họa cho con sẽ xấu hổ thẹn thùng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 72, '[SECTION] (71) Vương quyền của Đức Mê-si-a Vua
(1) Của vua Sa-lô-môn.
Tâu Thượng Đế, xin ban quyền bính Ngài cho vị Tân Vương,
trao công lý Ngài vào tay Thái Tử,
(2) để Tân Vương xét xử dân Ngài theo công lý,
và bênh vực quyền lợi kẻ nghèo hèn.
(3) Núi đem lại cảnh hòa bình trăm họ,
...
A-men. A-men.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 73, '[SECTION] (72) Điều thắc mắc của người công chính
(1) Thánh vịnh. Của ông A-xáp.
...
nơi cửa vào thành thánh Xi-on.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 74, '[SECTION] (73) Than vãn vì Đền Thờ bị tàn phá và thù địch lộng hành
...
tiếng quân địch thét gào vang lên mãi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 75, '[SECTION] (74) Thiên Chúa là thẩm phán công minh
(1) Phần ca trưởng. “Xin đừng phá đổ.” Thánh vịnh. Của ông A-xáp. Thánh ca.
...
còn uy thế người lành sẽ được nâng cao.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 76, '[SECTION] (75) Tạ ơn sau khi chiến thắng
(1) Phần ca trưởng. Theo huyền cầm. Thánh vịnh. Của ông A-xáp. Thánh ca.
...
Kẻ hầu cận Đấng khả tôn khả úy
hãy đem lễ vật tiến dâng Người.
(13) Người đập tan khí thế bao thủ lãnh,
gây kinh hoàng cho vua chúa trần gian.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 77, '[SECTION] (76) Hồi tưởng những kỳ công của Thiên Chúa
(1) Phần ca trưởng... Giơ-đu-thun. Của ông A-xáp. Thánh vịnh.
...
như dẫn dắt đoàn chiên.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 78, '[SECTION] (77) Lịch sử Ít-ra-en cho thấy Thiên Chúa nhân từ mà dân Chúa lại bội bạc
(1) Thi khúc. Của ông A-xáp.
...
(47) mưa đá hủy vườn nho, sương muối diệt cây vả,
...
(63) Lửa chiến chinh hủy diệt đời trai tráng,
...
(70) Chúa chọn Đa-vít, tôi tớ Người,
...
tay dẫn đưa khéo léo tài tình.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 79, '[SECTION] (78) Lời than vãn về thành thánh Giê-ru-sa-lem và Đền Thờ bị phá hủy
(1) Thánh vịnh. Của ông A-xáp.
...
(4) Chúng con bị láng giềng thóa mạ
...
và dâng lời ca tụng đến muôn thuở muôn đời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 80, '[SECTION] (79) Lạy Thiên Chúa, xin thăm nom vườn nho của Chúa
...
(6) Cơm Ngài cho ăn chỉ là châu lụy,
...
(17) Những người đã hỏa thiêu chặt phá,
...
xin tỏa ánh tôn nhan rạng ngời
để chúng con được ơn cứu độ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 81, '[SECTION] (80) Long trọng nhắc lại lời giao ước
...
(3) Đàn hát lên nào, hòa nhịp trống cơm,
...
mật ong rừng, Ta cho hưởng thỏa thuê.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 82, '[SECTION] (81) Tố cáo những thẩm phán bất công
(1) Thánh vịnh. Của ông A-xáp.
...
vì chính Ngài làm chủ muôn dân.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 83, '[SECTION] (82) Kẻ thù của Ít-ra-en liên minh chống lại Ít-ra-en và Thiên Chúa
...
cùng chung vận mệnh với De-vác và Xan-mun-na;
...
(15) Giống như lửa thiêu rừng, tựa hỏa hào đốt núi,
...
Đấng Tối Cao trên khắp địa cầu.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 84, '[SECTION] (83) Ước mong về Đền Thánh
(1) Phần ca trưởng. Có họa đàn thành Gát. Của con cái ông Cô-rắc. Thánh vịnh.
...
(13) Lạy Chúa Tể càn khôn, phúc thay người tin tưởng vào Chúa!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 85, '[SECTION] (84) Xin ơn bình an và cứu độ
(1) Phần ca trưởng. Của con cái ông Cô-rắc. Thánh vịnh.
...
mở lối cho Người đặt bước chân.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 86, '[SECTION] (85) Người khó nghèo cầu nguyện trong cơn quẫn bách
...
(3) Xin rủ lòng thương con, lạy Chúa:
con kêu con gọi Chúa suốt ngày.
(4) Lạy Chúa, xin làm cho con được vui thỏa,
...
vì, lạy CHÚA, chính Ngài giúp đỡ ủi an con.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 87, '[SECTION] (86) Thành Xi-on là mẹ muôn dân
...
“Xi-on hỡi, mọi nguồn gốc của tôi ở nơi thành.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 88, '[SECTION] (87) Lời cầu xin trong lúc ngặt nghèo
...
dồn dập tư bề như nước bao la.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 89, '[SECTION] (88) Lòng nhân nghĩa của ĐỨC CHÚA đối với nhà Đa-vít
...
(38) muôn đời kiên cố như vầng nguyệt
...
(51) Lạy Chúa, xin nhớ rằng: các tôi tớ Ngài bị thóa mạ,
những lời phỉ báng của chư dân,
con đây vẫn chất chứa trong lòng.
(52) Vâng, lạy CHÚA, kẻ thù Ngài thóa mạ,
theo sát gót mà buông lời thóa mạ
đấng Ngài đã xức dầu tấn phong.
(53) Chúc tụng CHÚA đến muôn đời. A-men. A-men.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 90, '[SECTION] (89) Đời sống con người mong manh và mỏng giòn
...
xin củng cố việc tay chúng con làm.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 91, '[SECTION] (90) Nương bóng Chúa toàn năng
...
và hưởng ơn cứu độ Ta ban.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 92, '[SECTION] (91) Ca tụng ĐỨC CHÚA, Đấng chính trực công minh
...
(4) hòa điệu sắt cầm gieo trầm bổng,
...
nơi Người chẳng có chút bất công.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 93, '[SECTION] (92) ĐỨC CHÚA là Vua vũ trụ
...
triền miên qua mọi thời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 94, '[SECTION] (93) ĐỨC CHÚA xử công minh cho người lành
...
bọn gieo tai rắc họa chẳng kể gì luật pháp?
(21) Chúng tìm hại mạng sống người lành,
lên án tử cho người vô tội.
(22) Nhưng CHÚA là thành lũy chở che,
Chúa tôi thờ là núi đá cho tôi trú ẩn.
(23) Tội của chúng, Người đổ trên đầu chúng,
Người tiêu diệt chúng vì điều dữ chúng làm,
ĐỨC CHÚA là Thiên Chúa của ta, sẽ tiêu diệt chúng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 95, '[SECTION] (94) Lời mời gọi reo hò mừng ĐỨC CHÚA
...
Chúng sẽ không được vào chốn yên nghỉ của Ta.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 96, '[SECTION] (95) ĐỨC CHÚA là Vua và Thẩm Phán muôn dân
...
xét xử muôn dân theo chân lý của Người.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 97, '[SECTION] (96) ĐỨC CHÚA là Thẩm phán sẽ vinh quang ngự đến
...
tưởng nhớ Thánh Danh mà dâng lời cảm tạ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 98, '[SECTION] (97) ĐỨC CHÚA, Đấng toàn thắng và xét xử muôn dân
(1) Thánh vịnh.
...
Người xét xử địa cầu theo đường công chính,
xét xử muôn dân theo lẽ công bằng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 99, '[SECTION] (98) ĐỨC CHÚA là Vua cao cả và là Đấng Thánh
...
(4) Ngài là vua uy dũng yêu chuộng công bằng,
...
vì ĐỨC CHÚA, Thiên Chúa ta thờ, quả thật là Đấng Thánh.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 100, '[SECTION] (99) Mời gọi vào đền thánh để ca ngợi, tạ ơn ĐỨC CHÚA
...
qua bao thế hệ, vẫn một niềm thành tín.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 101, '[SECTION] (100) Chân dung của nhà vua lý tưởng
...
bọn làm điều ác, chẳng sót một tên.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 102, '[SECTION] (101) Lời than van rên siết trong cảnh gian truân
...
(20) Vì CHÚA đưa mắt từ tòa cao thánh điện,
...
và dòng giống tồn tại trước nhan Ngài.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 103, '[SECTION] (102) ĐỨC CHÚA là Đấng từ bi nhân hậu
(1) Của vua Đa-vít.
...
Chúc tụng CHÚA đi, hồn tôi hỡi!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 104, '[SECTION] (103) Ca tụng Đấng Tạo Hóa
...
(34) Nguyện tiếng lòng tôi làm cho Người vui thỏa,
đối với tôi, niềm vui là chính CHÚA.
(35) Ước gì tội nhân phải biệt tích cõi đời,
bọn bất lương sạch bóng chẳng còn ai.
Chúc tụng CHÚA đi, hồn tôi hỡi!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 105, '[SECTION] (104) Lịch sử kỳ diệu của Ít-ra-en
Ha-lê-lui-a.
...
(45) ngõ hầu họ vâng theo thánh chỉ, và tuân giữ luật Người.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 106, '[SECTION] (105) Chúa nhân từ đối với dân Ít-ra-en luôn bất trung
(1) Ha-lê-lui-a.
...
ngọn hỏa hào thiêu rụi phường gian ác.
...
(30) Pin-khát liền đứng ra phân xử, tai họa bỗng dứt ngay.
...
Toàn dân hãy hô lớn: A-men! A-men!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 107, '[SECTION] (106) Tạ ơn Chúa vì được Người giải thoát
(1) Ha-lê-lui-a.
Hãy tạ ơn CHÚA vì Chúa nhân từ,
muôn ngàn đời Chúa vẫn trọn tình thương.
...
(17) Họ hóa điên trong cuộc đời lầm lỗi,
...
(34) đất mầu mỡ hóa đồng chua nước mặn,
...
điêu đứng vì tai họa với khổ đau.
...
thì sẽ am tường lòng CHÚA thương yêu.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 108, '[SECTION] (107) Ca tụng Thiên Chúa và xin Người thương giúp
...
INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 109, '[SECTION] (108) Bị kẻ thù nguyền rủa, xin ĐỨC CHÚA ban phúc lành
(1) Phần ca trưởng. Của vua Đa-vít. Thánh vịnh.
...
sau một đời, tên tuổi bị xóa nhòa!
(14) Ước gì CHÚA nhớ lại tội cha ông nó,
lỗi của mẹ nó không hề được xóa bỏ đi!
(15) Các tội ấy cứ sờ sờ trước mặt CHÚA,
xin Chúa xóa nhòa tên tuổi chúng trên đời!
...
để cứu độ khỏi tay người kết án.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 110, '[SECTION] (109) Đấng Mê-si-a là Vua và Thượng Tế
(1) Của vua Đa-vít. Thánh vịnh.
...
nên sẽ ngẩng đầu thật hiên ngang.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 111, '[SECTION] (110) Sự nghiệp ĐỨC CHÚA oai phong hiển hách
(1) Ha-lê-lui-a.
[SECTION] A-lép
...
[SECTION] Tau
Mãi đến thiên thu còn vang tiếng ngợi khen Người.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 112, '[SECTION] (111) Hạnh phúc thay người công chính
(1) Ha-lê-lui-a.
[SECTION] A-lép
...
[SECTION] Tau
ước vọng của ác nhân sẽ chẳng còn.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 113, '[SECTION] (112) Danh Chúa đáng ca ngợi
(1) Ha-lê-lui-a.
...
thành mẹ đông con, vui cửa vui nhà.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 114, '[SECTION] (113A) Thiên Chúa cho Ít-ra-en vượt qua Biển Đỏ và sông Gio-đan
(1) Ha-lê-lui-a.
...
và sỏi đá nên mạch nước dồi dào.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 115, '[SECTION] (113B) Ca tụng ĐỨC CHÚA, Đấng duy nhất và nhân hậu
...
từ nay đến muôn đời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 116, '[SECTION] (114-115) Lời kinh tạ ơn
...
Ha-lê-lui-a.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 117, '[SECTION] (116) Kêu gọi mọi người ca tụng Chúa
(1) Muôn nước hỡi, nào ca ngợi CHÚA,
ngàn dân ơi, hãy chúc tụng Người!
(2) Vì tình Chúa thương ta thật là mãnh liệt,
lòng thành tín của Người bền vững muôn năm. Ha-lê-lui-a.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 118, '[SECTION] (117) Tạ ơn sau cuộc chiến thắng
...
muôn ngàn đời Chúa vẫn trọn tình thương.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 119, '[SECTION] (118) Ca ngợi Lề Luật
[SECTION] A-lép
...
(24) Vâng, thánh ý Ngài làm con vui sướng thỏa thuê,
...
vì luật Ngài làm con vui sướng thỏa thuê.
...
(92) Nếu luật Ngài chẳng làm con vui thỏa,
...
(135) Xin tỏa ánh tôn nhan rạng ngời trên tôi tớ Chúa,
...
mệnh lệnh Ngài vẫn làm con vui thỏa.
...
vì con chẳng quên mệnh lệnh của Ngài.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 120, '[SECTION] (119) Ước mong được sống bình an
(1) Ca khúc lên Đền.
...
Nhưng hễ tôi nói tới, thì phe họ lại muốn chiến tranh.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 121, '[SECTION] (120) ĐỨC CHÚA là Đấng bảo vệ Dân
(1) Ca khúc lên Đền.
...
từ giờ đây cho đến mãi muôn đời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 122, '[SECTION] (121) Thành Thánh Giê-ru-sa-lem
...
tôi ước mong thành được hạnh phúc, hỡi thành đô.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 123, '[SECTION] (122) Dân Ít-ra-en bị áp bức đặt hy vọng nơi Thiên Chúa
(1) Ca khúc lên Đền.
Con ngước mắt hướng nhìn lên Chúa,
Đấng đang ngự trên trời.
(2) Quả thật như mắt của gia nhân hướng nhìn tay ông chủ,
...
giọng khinh người của bọn kiêu căng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 124, '[SECTION] (123) Ít-ra-en được phù hộ khi kêu cầu danh ĐỨC CHÚA
(1) Ca khúc lên Đền. Của vua Đa-vít.
...
Đấng đã dựng nên cả đất trời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 125, '[SECTION] (124) ĐỨC CHÚA che chở Dân Người
(1) Ca khúc lên Đền.
...
Nguyện chúc Ít-ra-en được thái bình.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 126, '[SECTION] (125) Niềm vui và hy vọng đặt nơi Chúa
(1) Ca khúc lên Đền.
...
lúc trở về, về reo hớn hở, vai nặng gánh lúa vàng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 127, '[SECTION] (126) Vất vả uổng công, nếu không có Chúa giúp
...
tranh tụng với địch thù.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 128, '[SECTION] (127) Hạnh phúc thay kẻ kính sợ Chúa
(1) Ca khúc lên Đền.
...
Nguyện chúc Ít-ra-en vui hưởng thái bình.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 129, '[SECTION] (128) Bị hà hiếp, dân Chúa vẫn một niềm tin tưởng
(1) Ca khúc lên Đền.
...
Chúng tôi chúc lành cho anh em nhân danh CHÚA.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 130, '[SECTION] (129) Tiếng kêu từ vực thẳm
(1) Ca khúc lên Đền.
...
cho thoát khỏi tội khiên muôn vàn.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 131, '[SECTION] (130) Như trẻ thơ đặt hết niềm tin nơi Chúa
(1) Ca khúc lên Đền. Của vua Đa-vít.
...
từ nay đến mãi muôn đời muôn năm.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 132, '[SECTION] (131) Lời Chúa hứa cùng nhà Đa-vít
(1) Ca khúc lên Đền.
...
còn trên đầu vua, rực rỡ ánh triều thiên.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 133, '[SECTION] (132) Anh em thuận hòa thì tốt đẹp biết bao
(1) Ca khúc lên Đền. Của vua Đa-vít.
...
chính là sự sống chứa chan muôn đời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 134, '[SECTION] (133) Kinh đêm trong Đền Thánh
(1) Ca khúc lên Đền.
...
từ núi thánh Xi-on.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 135, '[SECTION] (134) Ca tụng Chúa đã thực hiện bao kỳ công
(1) Ha-lê-lui-a.
...
INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 136, '[SECTION] (135) Tạ ơn Thiên Chúa
(1) Hãy tạ ơn CHÚA vì Chúa nhân từ,
muôn ngàn đời Chúa vẫn trọn tình thương.
...
INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 137, '[SECTION] (136) Trên bờ sông Ba-by-lon
...
mà đem đập vào đá.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 138, '[SECTION] (137) Lời cảm tạ
(1) Của vua Đa-vít.
...
Công trình do tay Ngài thực hiện, xin đừng bỏ dở dang.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 139, '[SECTION] (138) ĐỨC CHÚA ở khắp mọi nơi, biết hết mọi sự
(1) Phần ca trưởng. Của vua Đa-vít. Thánh vịnh.
...
(21) Lạy CHÚA, kẻ ghét Ngài, làm sao con không ghét?
...
thì dẫn con theo chính lộ ngàn đời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 140, '[SECTION] (139) ĐỨC CHÚA là Đấng bảo vệ người khốn khổ khó nghèo
(1) Phần ca trưởng. Thánh vịnh. Của vua Đa-vít.
...
kẻ ngay lành được ở trước Thánh Nhan.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 141, '[SECTION] (140) Lời cầu cho khỏi bị lôi kéo làm điều ác
(1) Thánh vịnh. Của vua Đa-vít.
...
còn con đây thì được thoát khỏi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 142, '[SECTION] (141) ĐỨC CHÚA là nơi tôi trú ẩn
...
vì con đã được Ngài thi ân giáng phúc.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 143, '[SECTION] (142) Lời cầu xin lúc gặp hiểm nguy
(1) Thánh vịnh. Của vua Đa-vít.
...
Xin đừng ẩn mặt đi, kẻo con hóa ra người thiên cổ.
...
vì con là tôi tớ của Ngài.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 144, '[SECTION] (143) Xin được chiến thắng và hưởng cảnh thịnh vượng
(1) Của vua Đa-vít.
Chúc tụng CHÚA là núi đá cho tôi nương ẩn,
là Đấng dạy tôi nên người thiện chiến,
luyện thành tay võ nghệ cao cường.
(2) Chúa là đồng minh, là đồn lũy che chở,
...
(6) xin tung chớp lòa khiến địch quân tán loạn,
...
Hạnh phúc thay dân nào được CHÚA TRỜI làm Chúa!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 145, '[SECTION] (144) Ca ngợi ĐỨC CHÚA là Vua
...
đến muôn thuở muôn đời!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 146, '[SECTION] (145) Phúc thay người trông cậy Chúa
(1) Ha-lê-lui-a!
...
Xi-on hỡi, Chúa Trời ngươi hiển trị ngàn đời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 147, '[SECTION] (146-147) Ca tụng ĐỨC CHÚA là Đấng Toàn Năng
(1) Ha-lê-lui-a!
Hãy ca ngợi CHÚA đi!
...
INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 148, '[SECTION] Kêu mời toàn thể tạo thành chúc tụng ĐỨC CHÚA
(1) Ha-lê-lui-a!
...
INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 149, '[SECTION] Các tín hữu ca khúc khải hoàn
(1) Ha-lê-lui-a!
Hát lên mừng CHÚA một bài ca mới,
...
INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'tv', 150, '[SECTION] Ca tụng Chúa đi
(1) Ha-lê-lui-a!
