...
và ván ghép tường là trắc bá diệp.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dc', 2, '(1) – Em là đóa thủy tiên của Sa-rôn đồng bằng,
...
hãy làm linh dương, làm nai nhỏ trên dãy núi Be-the!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dc', 3, '(1) Suốt đêm, trên giường ngủ, tôi tìm người lòng tôi yêu dấu.
...
ngày vui nhất của lòng người.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dc', 4, '[SECTION] CHÀNG
...
(4) Cổ nàng đẹp như tháp ngà Đa-vít
...
Áo em tỏa hương thơm ngào ngạt tựa hương núi Li-băng.
...
thổi mát vườn của tôi, cho hương thơm lan tỏa!
Người tôi yêu cứ vào vườn của chàng
mà thưởng thức hoa thơm trái tốt.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dc', 5, '[SECTION] CHÀNG
...
hỡi thiếu nữ Giê-ru-sa-lem!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dc', 6, '[SECTION] ĐỒNG CA
...
bước lên xa giá ngọc ngà chúa tôi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dc', 7, '[SECTION] ĐỒNG CA
...
hỡi người em yêu dấu!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dc', 8, '(1) Phải chi anh là anh ruột của em,
...
tung tăng trên núi đồi cỏ thơm bát ngát.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;