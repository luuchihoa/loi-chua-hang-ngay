...
(8) Bà cai sữa cho Lô Ru-kha-ma, rồi lại có thai và sinh một con trai. (9) ĐỨC CHÚA phán: “Đặt tên cho nó là Lô Am-mi (‘Không-phải-dân-Ta’), vì các ngươi không phải là dân của Ta, và đối với các ngươi, Ta kể như không có.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hs', 2, '[SECTION] Viễn ảnh tương lai
...
[SECTION] ĐỨC CHÚA và hôn thê không chung thủy của Người
(4) Hãy đưa mẹ các ngươi ra tòa, đưa nó ra tòa đi!
...
Còn nó sẽ thưa: “Thiên Chúa của con!”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hs', 3, '[SECTION] Ông Hô-sê nhận lại người vợ không chung thủy và thử thách bà. Ý nghĩa của biểu tượng.
...
(4) Vì quả thật, trong một thời gian dài, con cái Ít-ra-en sẽ không có vua, không thủ lãnh, không hy lễ cũng chẳng có trụ thần, chẳng có ê-phốt và tơ-ra-phim. (5) Sau đó, con cái Ít-ra-en sẽ trở lại tìm kiếm ĐỨC CHÚA, Thiên Chúa của chúng, và tìm Đa-vít, vua của chúng. Ngày lại ngày chúng sẽ đem lòng kính sợ mà hướng về ĐỨC CHÚA và chờ mong ân huệ của Người.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hs', 4, '[PART] II. ÍT-RA-EN PHẠM TỘI VÀ BỊ TRỪNG PHẠT
[SECTION] Tình trạng đồi bại chung
...
tất cả đều chết hết.
[SECTION] Lên án hàng tư tế
(4) Thế mà chẳng có ai kiện tụng, chẳng có ai trách mắng!
Nhưng hỡi tư tế, chính Ta sẽ đưa ngươi ra tòa.
...
(10) Chúng ăn mà chẳng no, làm điếm mà chẳng sinh sôi nảy nở,
vì chúng đã bỏ không thờ ĐỨC CHÚA.
[SECTION] Phụng tự của Ít-ra-en: thờ ngẫu tượng và sống sa đọa
...
sẽ hổ thẹn vì hiến lễ của mình.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hs', 5, '[SECTION] Tư tế và vua chúa quan quyền đưa dân tới chỗ diệt vong
...
[SECTION] Chiến tranh huynh đệ tương tàn
...
[SECTION] Liên minh với ngoại bang chỉ là hư ảo
...
chúng sẽ mau mắn tìm Ta trong cơn khốn quẫn.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hs', 6, '[SECTION] Trở về với ĐỨC CHÚA, nhưng không thật lòng.
...
[SECTION] Tội ác của Ít-ra-en xưa và nay
...
khi Ta đổi số phận dân Ta.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hs', 7, '(1) Khi Ta muốn chữa Ít-ra-en cho lành,
...
(4) tất cả bọn chúng là một đám ngoại tình,
chẳng khác chi hỏa lò phừng phực cháy
...
lòng chúng chẳng khác chi hỏa lò:
suốt đêm cơn giận của chúng ngủ yên,
nhưng bừng lên như ngọn hỏa hào khi trời sáng;
(7) cả đám phừng phực như hỏa lò
đốt tiêu tan các quan tòa của chúng;
hết thảy các vua đều gục ngã
mà không ai trong chúng kêu cầu Ta.
[SECTION] Ít-ra-en điêu tàn vì cầu cứu ngoại bang
...
(10) Ít-ra-en kiêu ngạo, tội nó tố cáo nó.
Chúng đâu chịu trở về
...
[SECTION] Ít-ra-en bị trừng phạt vì vô ơn
...
Chúng chẳng khác nào cánh cung sai chạy.
Thủ lãnh chúng ngã gục dưới lưỡi gươm,
vì thốt ra những lời giận dữ;
trong đất Ai-cập, chúng sẽ nên trò cười.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hs', 8, '[SECTION] Báo động
(1) Thổi kèn báo động đi!
Như phượng hoàng, tai họa chụp xuống nhà ĐỨC CHÚA,
...
[SECTION] Xã hội hỗn loạn vì dân Chúa thờ ngẫu tượng
...
[SECTION] Ít-ra-en bị tiêu diệt vì cầu cứu ngoại bang
(8) Ít-ra-en đã bị nuốt chửng.
...
[SECTION] Chống nền phụng tự vụ hình thức
...
và lửa sẽ ngốn hết các dinh thự.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hs', 9, '[SECTION] Sầu khổ ở chốn lưu đày
...
(3) Không được ở trên đất của ĐỨC CHÚA,
...
[SECTION] Ngôn sứ bị khủng bố vì loan báo cuộc trừng phạt
...
Người không quên điều gian ác chúng làm,
nhưng sẽ trị tội chúng.
[SECTION] Trừng phạt tội ác tại Ba-an Pơ-o
...
và trở thành đồ ghê tởm như những thần chúng yêu mến.
...
(13) Xưa Ta thấy Ép-ra-im như thành Tia tọa lạc trong đồng cỏ,
nhưng nay Ép-ra-im
...
[SECTION] Trừng phạt tội ác tại Ghin-gan
...
giữa chư dân, chúng sẽ phải lang thang phiêu bạt.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hs', 10, '[SECTION] Ngẫu tượng Ít-ra-en thờ sẽ bị phá hủy
...
chúng càng làm thêm những trụ thần lộng lẫy.
...
(4) Chúng ăn nói ba hoa, thề gian thề dối, thỏa hiệp với mọi người,
...
(8) Các nơi cao của A-ven sẽ bị phá hủy, đó là tội của Ít-ra-en.
...
[SECTION] Ít-ra-en đã không đáp ứng điều ĐỨC CHÚA chờ đợi
...
Tất cả các pháo đài của ngươi đều bị phá hủy,
như San-man phá hủy Bết Ác-vên,
...
ngay từ rạng đông chắc chắn vua Ít-ra-en sẽ bị rồi đời!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hs', 11, '[SECTION] ĐỨC CHÚA báo oán cho tình yêu bị khước từ
...
[SECTION] Nhưng ĐỨC CHÚA lại tha thứ
...
[SECTION] Trở về từ chốn lưu đày
...
INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hs', 12, '[SECTION] Ít-ra-en lụn bại về tôn giáo và chính trị
...
[SECTION] Lên án Gia-cóp và Ép-ra-im
...
[SECTION] Viễn ảnh hòa giải với Thiên Chúa
...
Những nhục mạ nó đã gây nên, Chúa sẽ bắt nó phải đền bù.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hs', 13, '[SECTION] Trừng phạt tội thờ ngẫu tượng
(1) Xưa kia hễ Ép-ra-im lên tiếng là nó gây kinh hoàng,
...
như làn khói tỏa từ ống thông hơi.
[SECTION] Trừng phạt tội vô ơn bạc nghĩa
...
(6) Vừa khi ra đồng cỏ, chúng liền được ăn uống thỏa thuê.
Nhưng khi thỏa thuê rồi, chúng đâm ra tự cao tự đại.
...
[SECTION] Sự sụp đổ không tránh được
...
Cơn gió ấy sẽ cướp đi kho tàng, cuốn hết mọi bảo vật.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hs', 14, '(1) Sa-ma-ri sẽ phải đền tội vì đã phản bội Thiên Chúa của mình.
Chúng sẽ gục ngã vì gươm đao,
con thơ của chúng sẽ bị tan xác, phụ nữ mang thai bị mổ bụng.
[PART] III. ÍT-RA-EN HỐI CẢI VÀ ĐƯỢC CHÚA THƯƠNG
[SECTION] Ít-ra-en thành tâm trở về với ĐỨC CHÚA
...
còn kẻ gian ác sẽ phải té nhào.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;