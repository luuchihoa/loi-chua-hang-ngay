...
tôi hết được nghỉ ngơi, vì trăm điều phiền muộn.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 4, '[SECTION] Tin tưởng vào Thiên Chúa
...
Chúng chết mà chẳng hiểu tại sao mình chết.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 5, '(1) Anh cứ gọi xem! Liệu có ai trả lời anh chăng?
...
cũng như những tia chớp lóe lửa trên cao.
...
đến lần thứ bảy, tai họa không sao hại được anh.
...
tai họa có đến, anh cũng chẳng sợ chi.
...
sự thật là như thế:
xin anh nghe và rút tỉa điều lợi ích cho mình.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 6, '[SECTION] Chỉ có ai đau khổ mới hiểu được nỗi khổ của mình
...
Chẳng lẽ chưa bao giờ tôi nếm mùi cay đắng gian truân?') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 7, '(1) Cuộc sống con người nơi dương thế
...
(5) Thịt tôi chai ra, giòi bọ lúc nhúc,
...
(21) Chẳng lẽ Ngài không xóa được tội ác của con,
không bỏ qua được lỗi lầm con phạm?
Vì chỉ ít nữa thôi, con sẽ ngủ vùi trong cát bụi.
Ngài có tìm cũng chẳng thấy con đâu.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 8, '[SECTION] Cần học hỏi về đức công chính của Thiên Chúa
...
và đâm chồi nẩy lộc tỏa khắp thửa vườn.
...
nơi ở của phường gian ác cũng chẳng còn.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 9, '[SECTION] Đức công chính của Thiên Chúa vượt trên tất cả
...
Cậy vào tòa xét xử? Nhưng ai cắt cử Người?
...
để cùng với Người ra trước tòa xét xử.
...
vì tôi thấy tôi đâu có như vậy!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 10, '(1) Hồn tôi chẳng còn ham sống,
...
chẳng lẽ Ngài đổi ý mà hủy diệt?
...
Xin Ngài nương tay, để con được đôi phần thanh thỏa,
(21) trước khi con ra đi, không hẹn ngày trở lại,
đi về nơi tăm tối, dưới bóng tử thần,
(22) nơi tăm tối, mịt mù, hỗn độn,
nơi ánh sáng và bóng tối cũng như nhau.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 11, '[SECTION] Sự khôn ngoan của Thiên Chúa mời gọi ông Gióp thú tội
...
(15) thì bấy giờ, anh sẽ ngẩng mặt lên, không tỳ ố,
anh sẽ được vững vàng, không sợ hãi chi.
(16) Vì bấy giờ anh sẽ quên tai họa,
...
hy vọng của chúng là trút hơi thở cuối cùng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 12, '[SECTION] Thiên Chúa quyền năng biểu lộ sự khôn ngoan qua các hành động của Người
(1) Bấy giờ ông Gióp lên tiếng nói:
...
(14) Người phá hủy, chẳng ai xây lại được,
...
lảo đảo như người thấm men say.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 13, '(1) Những chuyện này chính mắt tôi đã thấy,
...
(28) Con người mục nát như gỗ mọt, như tấm áo đã bị mối xông.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 14, '(1) Con người do phụ nữ sinh ra,
tuổi đời ngắn ngủi, mà âu lo chồng chất.
(2) Tựa đóa hoa mới nở đã tàn,
...
tang tóc trong tâm hồn, chỉ một mình nó hay.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 15, '[PART] 2. THIÊN THỨ HAI
[SECTION] Ông Ê-li-phát kết án ông Gióp
(1) Bấy giờ, ông Ê-li-phát người Tê-man lên tiếng nói:
...
mà biện hộ cho mình?
(4) Anh hủy bỏ luôn lòng kính sợ Thiên Chúa,
...
(35) Đứa cưu mang gian ác, ắt sẽ sinh tai họa,
bụng chúng chứa sẵn những điều gian.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 16, '[SECTION] Con người không công chính còn Thiên Chúa công chính
(1) Bấy giờ, ông Gióp lên tiếng nói:
...
(8) Ngài đã để cho da con phải nhăn nheo xấu xí,
...
Người nghiến răng nghiến lợi dọa dẫm tôi.
Kẻ thù tôi đưa mắt nhìn tôi chòng chọc.
(10) Chúng há mồm há miệng dọa dẫm tôi, lại hè nhau chế giễu,
...
con đường tôi đang đi không dẫn tôi trở lại.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 17, '(1) Hơi thở tôi đã cạn, ngày đời tôi đã hết,
...
khi ta cùng nhau yên nghỉ trong bụi đất?') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 18, '[SECTION] Giận dữ cũng chẳng làm gì được Thiên Chúa
(1) Bấy giờ ông Bin-đát, người Su-ác, lên tiếng nói:
...
nơi sinh sống của người không biết Thiên Chúa là như vậy!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 19, '[SECTION] Bị Thiên Chúa và con người bỏ rơi, nhưng vẫn tin
(1) Bấy giờ, ông Gióp lên tiếng nói:
...
(4) Giả như tôi có thật sự sai lầm, thì chỉ một mình tôi phải liên lụy.
...
mà đi săn đuổi tôi, và vẫn không thỏa mãn?
...
(26) Sau khi da tôi đây bị tiêu hủy,
...
thế nào cũng có một cuộc xét xử.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 20, '[SECTION] Thiên Chúa công chính không miễn trừ ai
(1) Bấy giờ, ông Xô-pha người Na-a-mát lên tiếng nói:
...
(20) vì khát vọng của nó chẳng bao giờ thỏa mãn,
...
(26) Mọi tai họa khủng khiếp nhất
đe dọa những kho tàng nó thu tích được.
...
là số phận Thiên Chúa định cho nó.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 21, '[SECTION] Thực tế không phải vậy
(1) Bấy giờ ông Gióp lên tiếng nói:
(2) Xin hãy lắng nghe lời tôi nói, và như thế đã là an ủi tôi.
...
Những câu giải đáp của các anh, chỉ là trò giả dối!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 22, '[PART] 3. THIÊN THỨ BA
[SECTION] Thiên Chúa trừng phạt nhân danh công lý
...
anh sẽ được giải thoát nhờ bàn tay trong sạch của anh.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 23, '[SECTION] Thiên Chúa ở xa nên sự ác thắng thế
(1) Bấy giờ ông Gióp lên tiếng nói:
...
tôi vẫn không nín lặng làm thinh.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 24, '(1) Tại sao Đấng Toàn Năng
...
và không tử tế với người góa bụa.
...
ai có thể nói ngược lại tôi, và cho lời tôi là vô giá trị?') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 25, '[SECTION] Thánh thi ca tụng quyền năng Thiên Chúa
(1) Bấy giờ, ông Bin-đát người Su-ác lên tiếng nói:
(2) Thiên Chúa nắm quyền thống trị,
Người đáng kinh đáng sợ dường nào.
Người thiết lập hòa bình trên cõi trời cao.
...
và con người, cũng chỉ thuộc loại sâu.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 26, '[SECTION] Ông Bin-đát nói vu vơ
...
chúng sững sờ khi Người hăm dọa.
(12) Người dùng sức mạnh chặt biển khơi,
lấy trí tuệ phanh thây thủy thần Ra-háp.
...
còn sức mạnh hùng vĩ của Người, nào có ai hiểu nổi?') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 27, '[SECTION] Ông Gióp nhìn nhận quyền năng Thiên Chúa
...
cháu chắt nó không được ăn thỏa thích.
...
và huýt sáo tại khắp nơi nó ở.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 28, '[PART] 4. CA TỤNG KHÔN NGOAN
[SECTION] Khôn ngoan con người không thể đạt được
...
tránh xa điều ác, đó là trí hiểu.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;
...
tôi đem lại niềm vui cho lòng góa phụ.
(14) Tôi đã mặc lấy đức công chính như áo che thân,
lấy lẽ công minh làm mũ đội đầu và áo khoác.
(15) Tôi nên mắt cho kẻ mù lòa, thành chân cho người què quặt.
...
(13) Họ phá hủy con đường tôi đi để tiêu diệt tôi,
...
làm con tan chảy trong dông tố bão bùng.
...
(31) Đàn tôi văng vẳng khúc nhạc sầu, sáo tôi dìu dặt cung ai oán.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 31, '[SECTION] Lời biện hộ của ông Gióp
(1) Tôi đã kết ước với đôi mắt của tôi
...
(3) Há chẳng phải tai họa cho đứa bất công
...
(14) thì tôi sẽ làm gì khi Thiên Chúa trỗi dậy,
...
làm cho mắt góa phụ mỏi mòn vì trông ngóng?
...
(23) Bởi vì tai họa của Thiên Chúa làm tôi kinh hãi,
...
“Ai là người không được cho ăn thịt thỏa thuê?”
...
và những luống đất cùng nhau khóc òa,
...
Đến đây hết lời của ông Gióp.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 32, '[PART] III. LỜI LẼ CỦA ÔNG Ê-LI-HU
[SECTION] Ông Ê-li-hu can thiệp
...
sẽ cất tôi đi trong khoảnh khắc.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 33, '[SECTION] Lòng tự cao của ông Gióp
(1) Này ông Gióp, xin nghe tôi ngỏ lời,
...
(4) Sinh khí của Thiên Chúa đã làm ra tôi,
...
lẳng lặng mà nghe tôi dạy lẽ khôn ngoan.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 34, '[SECTION] Ba nhà khôn ngoan không biện hộ nổi cho Thiên Chúa
...
và xử với mỗi người tùy theo cách họ sống.
...
(17) Người ghét lẽ công bằng, làm sao cai trị nổi?
...
nơi phàm nhân phải đến để hầu tòa.
...
và gia tăng lời chống báng Thiên Chúa.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 35, '[SECTION] Thiên Chúa không dửng dưng trước công việc của con người
...
vì thiếu hiểu biết mà dài dòng văn tự.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 36, '[SECTION] Ý nghĩa đích thực những đau khổ của ông Gióp
...
[SECTION] Thánh thi ca ngợi đức khôn ngoan toàn năng
...
bão bùng dông tố cho biết Người nổi trận lôi đình.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 37, '(1) Chính vì thế mà tim tôi run lẩy bẩy,
...
và cho chớp lóe cả mười phương đất.
...
và từ mây, Người làm cho chớp lóe.
...
Người khiến mây tỏa sáng làm sao?
...
đến những kẻ tưởng mình khôn ngoan.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 38, '[PART] IV. LỜI ĐỨC CHÚA PHÁN DẠY
[PART] LỜI THỨ NHẤT
[SECTION] Công trình sáng tạo của Đức Khôn Ngoan làm ông Gióp ngỡ ngàng
...
(7) khi các vì sao ban sáng đang hòa tấu nhịp nhàng
...
(24) Ánh sáng tỏa ra theo hướng nào,
...
và lang thang đây đó vì thiếu của ăn?') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 39, '(1) Ngươi có biết mùa sơn dương sinh nở,
...
xác chết ở đâu là nó ở đó.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 40, '(1) Bấy giờ, ĐỨC CHÚA lên tiếng trả lời ông Gióp:
(2) Hỏi rằng kẻ tranh luận với Đấng Toàn Năng, có gì để chỉ trích,
...
[PART] LỜI THỨ HAI
[SECTION] Thiên Chúa chế ngự sức mạnh của sự dữ
(6) Bấy giờ, giữa cơn bão táp, ĐỨC CHÚA lên tiếng trả lời ông Gióp:
...
ngươi sẽ không còn dám chiến đấu nữa!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 41, '(1) Này, hy vọng thắng nó chỉ là ảo mộng,
chỉ thấy nó thôi là đã rụng rời,
(2) chẳng ai gan đến độ khiêu khích nó,
đối diện với nó, chẳng ai đứng vững.
(3) Ai đến gần nó mà yên lành được?
Dưới gầm trời này, không có một ai!
(4) Các phần chi thể của nó, Ta không nói đến làm sao được!
Sức mạnh vô song của nó, Ta sẽ kể ra.
(5) Vạt áo trước của nó, ai dám vén lên,
áo giáp kép của nó, ai đã chui vào?
(6) Hàm của nó, ai đã mở ra?
Chung quanh răng nó, toàn là kinh hãi.
(7) Lưng của nó tựa lớp lớp khiên che,
...
(10) Nó hắt hơi khiến tỏa ra ánh sáng,
...
nó là vua của muôn loài ác thú.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'g', 42, '[SECTION] Câu trả lời cuối cùng của ông Gióp
(1) Ông Gióp thưa với ĐỨC CHÚA:
...
[PART] V. ĐOẠN KẾT
[SECTION] ĐỨC CHÚA quở trách ba nhà khôn ngoan
(7) Sau khi nói những lời ấy với ông Gióp, ĐỨC CHÚA phán với ông Ê-li-phát, người Tê-man: “Ta bừng bừng nổi giận với ngươi và cả hai người bạn của ngươi nữa, bởi vì các ngươi đã không nói đúng đắn về Ta như Gióp, tôi tớ của Ta. (8) Vậy, bây giờ các ngươi hãy bắt bảy con bò và bảy con cừu, rồi đi gặp Gióp, tôi tớ của Ta. Các ngươi hãy dâng lễ toàn thiêu để cầu cho các ngươi và Gióp, tôi tớ của Ta, sẽ chuyển cầu cho các ngươi. Ta sẽ đoái nhìn nó và sẽ không xử với các ngươi xứng với sự ngu xuẩn của các ngươi, vì các ngươi đã không nói đúng đắn về Ta như Gióp, tôi tớ của Ta.” (9) Vậy ông Ê-li-phát người Tê-man, ông Bin-đát người Su-ác và ông Xô-pha người Na-a-mát, đã đi làm những điều ĐỨC CHÚA phán với họ. ĐỨC CHÚA đã đoái nhìn đến ông Gióp.
[SECTION] ĐỨC CHÚA khôi phục tài sản cho ông Gióp
(10) Vậy ĐỨC CHÚA đã khôi phục tài sản cho ông Gióp, khi ông chuyển cầu cho các bạn của mình. ĐỨC CHÚA đã tăng gấp đôi những gì ông Gióp đã có trước kia. (11) Tất cả anh em, chị em ông, tất cả bạn bè cũ lại tìm đến ông; họ đã cùng ăn bánh trong nhà của ông. Họ chia buồn và an ủi ông về tất cả tai họa ĐỨC CHÚA đã giáng xuống trên ông. Mỗi người tặng ông một đồng bạc và một chiếc nhẫn vàng. (12) ĐỨC CHÚA giáng phúc cho những năm cuối đời của ông Gióp nhiều hơn trước kia. Ông có mười bốn ngàn con chiên, sáu ngàn lạc đà, một ngàn đôi bò và một ngàn lừa cái. (13) Ông sinh được bảy con trai và ba con gái. (14) Ông đặt tên cho cô thứ nhất là “Bồ Câu”, cô thứ hai là “Hoa Quế” và cô thứ ba là “Phấn Thơm”. (15) Trong khắp xứ, người ta không sao tìm được những thiếu nữ xinh đẹp như con gái ông Gióp. Cha của các cô đã chia gia tài cho các cô như cho các anh em trai.
(16) Sau đó, ông Gióp còn sống thêm một trăm bốn mươi năm nữa, ông được thấy con cái cháu chắt đến bốn đời. (17) Ông Gióp đã qua đời và tuổi thọ của ông rất cao.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;