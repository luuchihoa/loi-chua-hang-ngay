...
[SECTION] Hạch tội quân giả hình
...
[SECTION] Than vãn về Giê-ru-sa-lem
...
đều phải tiêu vong.
[SECTION] Hạch bọn thờ cây thánh vườn thiêng
(29) Các ngươi sẽ phải xấu hổ
vì những cây vân hương
...
khiến cả hai cùng cháy mà không ai dập đi.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 2, '[SECTION] Hòa bình vĩnh cửu
...
[SECTION] Oai phong của ĐỨC CHÚA
...
(14) mọi quả núi ngạo nghễ
và mọi ngọn đồi vươn cao,
(15) mọi cây tháp cao vời
và mọi tường lũy kiên cố,
(16) mọi tàu bè Tác-sít
...
(21) Họ sẽ chui vào hang đá,
vào kẽ núi,
để tránh nỗi kinh hoàng ĐỨC CHÚA gây ra,
tránh oai phong lẫm liệt của Người,
khi Người đứng lên làm cho đất hãi hùng.
(22) Hãy tránh xa người đời,
họ chỉ có hơi thở trong lỗ mũi, có gì đáng giá đâu!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 3, '[SECTION] Cảnh hỗn loạn tại Giê-ru-sa-lem
...
(2) người hùng và chiến sĩ,
quan tòa và ngôn sứ,
thầy bói và kỳ mục,
(3) sĩ quan và thân hào,
cố vấn với phù thủy cao tay
và những kẻ thạo nghề bùa ngải.
(4) Ta sẽ đặt bọn nhãi con
...
[SECTION] Nỗi khốn khổ của Giê-ru-sa-lem
(25) Nam nhi của ngươi sẽ ngã gục vì gươm,
anh hùng của ngươi sẽ tử trận.
(26) Các cửa thành than vãn, để tang,
nó sẽ ngồi dưới đất trơ trọi một mình.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 4, '(1) Ngày đó, bảy bà sẽ níu lấy một ông mà nói: “Bánh ăn áo mặc, chúng em sẽ liệu lấy; chỉ xin được mang tên chàng, xin chàng cất đi cho nỗi khổ nhục của chúng em.”
[SECTION] Chồi non của ĐỨC CHÚA
...
vinh quang của Chúa
sẽ là tán che, (6) là mái lều
làm bóng râm ban ngày cho khỏi nóng,
làm nơi nương ẩn khi bão táp mưa sa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 5, '[SECTION] Bài ca vườn nho
...
[SECTION] Cơn thịnh nộ của ĐỨC CHÚA
...
và ánh sáng bị mây mù làm cho tối tăm.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 6, '[PART] 2. SÁCH ĐỨC EM-MA-NU-EN
[SECTION] ĐỨC CHÚA kêu gọi ông I-sai-a
(1) Năm vua Út-di-gia-hu băng hà, tôi thấy Chúa Thượng ngự trên ngai rất cao; tà áo của Người bao phủ Đền Thờ.
(2) Phía bên trên Người, có các Xê-ra-phim đứng chầu. Mỗi vị có sáu cánh: hai cánh để che mặt, hai cánh để che chân và hai cánh để bay.
(3) Các vị ấy đối đáp tung hô:
“Thánh! Thánh! Chí Thánh!
ĐỨC CHÚA các đạo binh là Đấng Thánh!
Cả mặt đất rạng ngời vinh quang Chúa!”
(4) Tiếng tung hô đó làm cho các trụ cửa rung chuyển; khắp Đền Thờ khói tỏa mịt mù. (5) Bấy giờ tôi thốt lên:
...
(6) Một trong các Xê-ra-phim bay về phía tôi, tay cầm một hòn than hồng người đã dùng cặp mà gắp từ trên bàn thờ. (7) Người đưa hòn than ấy chạm vào miệng tôi và nói:
...
[SECTION] Báo trước cuộc xâm lăng
(18) Đến ngày đó,
...
đó sẽ là nơi thả bò
và nơi chiên cừu giẫm nát.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 8, '[SECTION] Ông I-sai-a sinh một con trai
...
[SECTION] Suối Si-lô-ác và sông Êu-phơ-rát
(5) ĐỨC CHÚA lại phán với tôi lần nữa rằng:
(6) “Bởi vì dân này khinh dể nước mương Si-lô-ác chảy lững lờ, và rụng rời vì sợ Rơ-xin và con của Rơ-man-gia-hu, (7) cho nên, này, để hại chúng, Chúa Thượng sẽ làm cho nước Sông Cả dâng lên, dòng nước lũ chảy cuồn cuộn – vua Át-sua và tất cả vinh quang của vua ấy. Ở đâu, nó cũng sẽ dâng lên khỏi lòng sông, chỗ nào cũng tràn bờ. (8) Nó sẽ ùa vào Giu-đa, sẽ phủ, sẽ ngập, sẽ dâng lên tới cổ. Cánh nó dang ra sẽ bao trùm khắp chiều rộng của đất ngươi, hỡi Em-ma-nu-en! (9) Liên kết lại, hỡi các dân, các ngươi sẽ bị đập tan!
...
(14) Người sẽ là một thánh điện
và một hòn đá làm cho vấp,
...
(17) Tôi mong đợi ĐỨC CHÚA,
Đấng ẩn mặt không nhìn nhà Gia-cóp,
tôi trông cậy vào Người.
(18) Này tôi và những đứa con
mà ĐỨC CHÚA đã ban cho tôi,
trong Ít-ra-en, chúng tôi là những dấu hiệu điềm báo,
...
[SECTION] Đi trong đêm tối
(21) Họ lang thang trong xứ, khổ cực và đói,
khi đói, họ sẽ nổi giận,
sẽ nguyền rủa vua và Thiên Chúa của mình.
Họ sẽ ngước lên cao,
(22) rồi nhìn xuống đất, và kìa:
ngặt nghèo và tối tăm,
bóng đêm đè nặng,
và tứ phía mịt mù.
(23) Nhưng sẽ không còn bóng đêm ở nơi đang bị ngặt nghèo.
[SECTION] Ơn giải thoát
Thời đầu, Người đã hạ nhục đất Dơ-vu-lun và đất Náp-ta-li, nhưng thời sau, Người sẽ làm vẻ vang cho con đường ra biển, miền bên kia sông Gio-đan, vùng đất của dân ngoại.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 9, '(1) Dân đang lần bước giữa tối tăm
...
(4) Vì mọi giày lính nện xuống rần rần
...
(6) Người sẽ mở rộng quyền bính, và lập nền hòa bình vô tận
...
[SECTION] Các thử thách của vương quốc miền Bắc
...
(20) Mơ-na-se ăn thịt Ép-ra-im,
và Ép-ra-im ăn thịt Mơ-na-se,
cả hai cùng nhau đánh Giu-đa.
Dầu thế, Người vẫn chưa nguôi cơn thịnh nộ,
và tay Người vẫn còn giơ lên.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 10, '(1) Khốn thay những kẻ đặt ra các luật lệ bất công,
...
để biến bà góa thành mồi ngon cho chúng, và bóc lột kẻ mồ côi.
(3) Các người sẽ làm chi
...
[SECTION] Phần sống sót của Ít-ra-en
...
[SECTION] Cuộc xâm lăng
(28) Nó đến đánh Ai-giát,
đi qua Mích-rôn,
gửi hành lý ở Mích-mát.
...
bởi một Đấng oai hùng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 11, '[SECTION] Vị minh quân dòng dõi vua Đa-vít
(1) Từ gốc tổ Gie-sê,
...
[SECTION] Những người bị phân tán trở về
...
ngày họ từ đất Ai-cập đi lên.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 12, '[SECTION] Thánh vịnh
...
vì giữa ngươi, Đức Thánh của Ít-ra-en quả thật là vĩ đại!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 13, '[PART] 3. SẤM NGÔN VỀ CÁC DÂN NGOẠI
[SECTION] Về Ba-by-lon (Ba-ben)
...
mặt trăng sẽ không còn tỏa sáng.
...
Thời của nó đã gần đến, ngày của nó sẽ chẳng kéo dài.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 14, '[SECTION] Chấm dứt thời lưu đày
...
[SECTION] Cái chết của vua Ba-by-lon (Ba-ben)
...
[SECTION] Hạch tội người Phi-li-tinh
...
và kẻ nghèo khó trong dân Người sẽ vào đó náu ẩn.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 15, '[SECTION] Hạch tội Mô-áp
(1) Lời sấm hạch tội Mô-áp.
Phải, giữa đêm khuya, thành A Mô-áp
...
và những kẻ còn sót lại trên đất.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 16, '[SECTION] Lời thỉnh cầu của người Mô-áp
...
giữa ban trưa, xin tỏa bóng như màn đêm bao phủ,
...
nhánh của nó tỏa ra vượt qua biển cả.
(9) Vì thế, cùng với tiếng dân Gia-de nức nở,
ta khóc thương cây nho Xíp-ma.
Vì ngươi, nước mắt ta chan hòa, hỡi Khét-bôn và En-a-lê,
...
(13) Đó là lời ĐỨC CHÚA phán từ xưa về Mô-áp. (14) Và giờ đây ĐỨC CHÚA lại phán: Theo cách tính của người làm thuê thì còn đúng ba năm nữa, vinh quang của Mô-áp sẽ tàn tạ; dù có đông vô số, dân nó cũng sẽ chỉ còn một số ít, rất ít, hầu như không đáng kể.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 17, '[SECTION] Hạch tội Đa-mát và Ít-ra-en
(1) Lời sấm hạch tội Đa-mát.
Này đây Đa-mát bị xóa sổ, không còn phải là thành,
...
và tai họa thật vô phương cứu chữa.
...
ĐỨC CHÚA dọa, chúng liền xa chạy cao bay;
...
là số mạng dành cho kẻ bóc lột chúng ta.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 18, '[SECTION] Hạch tội dân Cút
...
như màn sương lan tỏa trong ánh nắng ngày mùa.
...
(7) Bấy giờ, lễ phẩm kính dâng ĐỨC CHÚA các đạo binh sẽ do một dân có thân hình to lớn và nước da bóng nhẫy, một dân xa gần ai cũng sợ, một dân hùng cường nắm quyền bá chủ, một miền đất sông ngòi chảy dọc ngang, đem đến nơi danh ĐỨC CHÚA các đạo binh ngự, tức là núi Xi-on.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 19, '[SECTION] Hạch tội Ai-cập
...
[SECTION] Ai-cập hối cải
(16) Ngày ấy, Ai-cập sẽ giống như đàn bà run rẩy sợ hãi, khi thấy tay ĐỨC CHÚA các đạo binh vung lên, giơ ra đánh nó. (17) Đất Giu-đa sẽ trở thành nỗi kinh hoàng cho Ai-cập. Mỗi lần nghe nhắc tới Giu-đa là nó run sợ, vì kế hoạch mà ĐỨC CHÚA các đạo binh đã quyết định để hại nó. (18) Ngày ấy, trong xứ Ai-cập sẽ có năm thành nói tiếng Ca-na-an và thề ước với ĐỨC CHÚA các đạo binh; một trong năm thành ấy sẽ được gọi là Thành Mặt Trời. (19) Ngày ấy, sẽ có một bàn thờ kính ĐỨC CHÚA ngay giữa đất Ai-cập, và một trụ đá kính ĐỨC CHÚA ở gần biên giới. (20) Đối với ĐỨC CHÚA các đạo binh, tại đất Ai-cập, bàn thờ và trụ đá đó sẽ là dấu hiệu và bằng chứng nói lên rằng: mỗi khi gặp kẻ áp bức mà họ kêu lên ĐỨC CHÚA, thì Người sẽ phái một đấng cứu tinh đến bảo vệ và giải thoát họ. (21) ĐỨC CHÚA sẽ làm cho người Ai-cập được nhận biết Người, và ngày ấy người Ai-cập sẽ nhận biết ĐỨC CHÚA. Họ sẽ dâng hy lễ và lễ phẩm mà phụng thờ Người; họ sẽ khấn hứa với ĐỨC CHÚA và giữ trọn những lời khấn ấy. (22) Nếu ĐỨC CHÚA có đánh phạt Ai-cập, thì Người đánh rồi lại chữa lành, và họ sẽ trở về cùng ĐỨC CHÚA; Người sẽ nhậm lời họ cầu xin và chữa họ lành. (23) Ngày ấy, sẽ có một con đường đi từ Ai-cập đến Át-sua; Át-sua sẽ sang Ai-cập và Ai-cập sang Át-sua. Ai-cập sẽ cùng với Át-sua phụng thờ Đức Chúa. (24) Ngày ấy, Ít-ra-en sẽ cùng với Ai-cập và Át-sua làm thành bộ ba. Đó là phúc lành ngay giữa cõi đất (25) mà ĐỨC CHÚA các đạo binh sẽ ban cho, khi Người phán: “Ta giáng phúc cho Ai-cập, dân của Ta, cho Át-sua, công trình tay Ta làm ra, và cho Ít-ra-en, cơ nghiệp của Ta.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 20, '[SECTION] Hạ thành Át-đốt
(1) Vào năm vua Át-sua là Xác-gôn biệt phái tướng tổng tư lệnh đến giao chiến và hạ thành Át-đốt, (2) thì chính lúc ấy, ĐỨC CHÚA phán qua trung gian của ông I-sai-a, con ông A-mốc, rằng: “Hãy bỏ miếng vải thô ngang thắt lưng ngươi đi, và cởi dép khỏi chân.” Theo lời dạy, ông đã ở trần và đi chân không. (3) ĐỨC CHÚA lại phán: “Cũng như tôi tớ Ta là I-sai-a suốt ba năm trường đã ở trần và đi chân không để nên dấu hiệu điềm báo cho người Ai-cập và người Cút thế nào, (4) thì cũng vậy, vua Át-sua sẽ dẫn người Ai-cập đi tù và người Cút đi đày, trẻ cũng như già, mình trần, chân không, mông hở. Thật là nhục nhã cho người Ai-cập. (5) Những ai xem Cút như mối hy vọng và Ai-cập như niềm tự hào sẽ phải sợ hãi và xấu hổ. (6) Ngày ấy, dân cư miền duyên hải này sẽ nói: “Đâu rồi niềm hy vọng của chúng ta, nơi chúng ta đến ẩn náu để được giúp đỡ hầu thoát khỏi tay vua Át-sua? Phần chúng ta, trốn ở đâu bây giờ?”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 21, '[SECTION] Ba-by-lon (Ba-ben) sụp đổ
...
Còn đúng một năm nữa, ví như một năm làm thuê, tất cả vinh quang của Kê-đa sẽ chấm dứt. (17) Sẽ còn rất ít kẻ sót lại trong số những dũng sĩ bắn cung tên của con cái Kê-đa. ĐỨC CHÚA, Thiên Chúa Ít-ra-en, đã phán như vậy.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 22, '[SECTION] Chống những trò vui nhộn tại Giê-ru-sa-lem
...
(22) Chìa khóa nhà Đa-vít, Ta sẽ đặt trên vai nó.
...
(24) Tất cả niềm vinh dự của gia đình, dòng dõi, cháu chắt nó, tất cả các bình lớn nhỏ, từ chén cốc đến chum vò đủ loại, đều treo vào đó. (25) Lời sấm của ĐỨC CHÚA các đạo binh: ngày ấy đinh đóng cột sẽ oằn, sẽ gãy, sẽ rơi xuống; bấy giờ, khối nặng treo ở đó sẽ tan tành. ĐỨC CHÚA phán như vậy.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 23, '[SECTION] Chống lại Tia
(1) Lời sấm về Tia.
...
(17) Sau bảy mươi năm, ĐỨC CHÚA sẽ viếng thăm Tia. Nó sẽ trở lại nghề đi khách kiếm tiền, làm điếm với mọi vương quốc trên thế giới, trên mặt đất này. (18) Nhưng tiền lời và tiền đi khách, nó sẽ hiến dâng ĐỨC CHÚA thay vì gom góp để dành. Tiền lời kiếm được sẽ dành cho những ai ở trước nhan ĐỨC CHÚA, để họ ăn no mặc đẹp.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 24, '[PART] 4. KHẢI HUYỀN
[SECTION] ĐỨC CHÚA phán xét
...
Cũng vì thế, cư dân trên cõi đất bị thiêu hủy,
chỉ còn một ít người sống sót.
[SECTION] Bài ca về thành bị phá
...
[SECTION] Những trận chiến cuối cùng
...
và vinh quang Chúa tỏ rạng trước mặt các kỳ mục của Người.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 25, '[SECTION] Thánh thi tạ ơn
...
(2) Ngài đã làm cho đô thị hóa ra đống đá,
...
phá cho bình địa, chỉ còn là bụi đất.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 26, '[SECTION] Thánh thi tạ ơn
...
Đất sẽ để lộ máu ra
và không còn che giấu thây những người bị sát hại.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 27, '(1) Ngày ấy, ĐỨC CHÚA sẽ dùng thanh gươm
...
(9) Chính nhờ vậy mà tội tình Gia-cóp được tẩy xóa,
và việc xóa bỏ tội lỗi đưa đến hậu quả này:
...
sẽ đến và thờ lạy ĐỨC CHÚA trên núi thánh tại Giê-ru-sa-lem.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 28, '[PART] 5. THI CA VỀ ÍT-RA-EN VÀ GIU-ĐA
[SECTION] Chống Sa-ma-ri
...
(17) Dây đo của Ta là công minh, mực thước của Ta là chính trực.
Nhưng mưa đá sẽ phá tan hầm dối trá,
nước lũ sẽ cuốn trôi nơi trú ẩn.
(18) Giao ước các ngươi ký với tử thần sẽ bị hủy,
...
Kế hoạch sao nhiệm mầu, sự khôn ngoan thật là cao cả!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 29, '[SECTION] Nói về Giê-ru-sa-lem
...
(3) Ta sẽ bao vây ngươi tứ phía, sẽ đắp lũy chung quanh ngươi,
...
(10) Vì trên các ngươi, ĐỨC CHÚA đã đổ xuống một thần khí hôn mê.
...
và sẽ kính úy Thiên Chúa của Ít-ra-en.
(24) Những người tâm trí lầm lạc sẽ có được sự hiểu biết,
và những kẻ ương ngạnh sẽ chấp nhận lời răn dạy.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 30, '[SECTION] Chống đoàn sứ giả được phái qua Ai-cập
...
[SECTION] Lời sấm khác chống lại phái đoàn
...
(11) Hãy rời đường bỏ lối, đừng nói đến Đức Thánh của Ít-ra-en
...
đều có tiếng đàn tiếng trống họa theo;
...
sẽ khiến lò bốc cháy.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 31, '[SECTION] Chống liên minh với Ai-cập
...
và có lò tại Giê-ru-sa-lem.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 32, '[SECTION] Vua công chính
...
(5) Kẻ ngu xuẩn sẽ không được gọi là cao thượng,
người quỷ quyệt không được coi là cao quý.
[SECTION] Kẻ ngu xuẩn và người cao thượng
...
[SECTION] Chống đàn bà Giê-ru-sa-lem
...
[SECTION] Đổ tràn thần khí
(15) cho đến ngày, từ trên cao, thần khí sẽ được đổ xuống trên chúng ta.
...
(17) Sự nghiệp của đức công minh sẽ là hòa bình.
...
và thả rong bò lừa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 33, '[SECTION] Ơn cứu độ người người mong đợi
...
các sứ giả hòa bình than khóc đắng cay.
...
còn miền Ba-san và núi Các-men hóa ra trơ trụi.
(10) ĐỨC CHÚA phán: “Giờ đây Ta đứng dậy,
...
Dân ở đó sẽ được tha tội.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 34, '[SECTION] Xử tội Ê-đôm
...
(5) Vì trên trời gươm Ta say máu: nó sắp giáng xuống Ê-đôm,
...
cát bụi hóa lưu huỳnh, đất đai thành nhựa cháy,
...
các đồn lũy kiên cố đầy những tầm ma và cỏ dại.
...
chúng sẽ ở lại đây hết đời này qua đời nọ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 35, '[SECTION] Giê-ru-sa-lem toàn thắng
...
đau khổ và khóc than sẽ biến mất.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 36, '[PART] PHỤ TRƯƠNG
[SECTION] Cuộc xâm lăng của vua Xan-khê-ríp
...
(23) Ngươi đã thóa mạ, lăng nhục ai,
...
[SECTION] Dấu hiệu cho vua Khít-ki-gia
...
ĐỨC CHÚA các đạo binh sẽ thực hiện điều đó.
[SECTION] Lời sấm liên quan tới Át-sua
...
[SECTION] Vua Xan-khê-ríp bị trừng phạt
...
(37) Vua Át-sua là Xan-khê-ríp nhổ trại và lên đường. Ông rút về Ni-ni-vê và ở lại đó. (38) Nhưng rồi khi ông đang sụp lạy thần Nít-rốc của ông trong đền thờ thì các hoàng tử Át-ram-me-léc và Xa-re-xe dùng gươm đâm ông chết rồi trốn sang xứ A-ra-rát. Con vua là Ê-xa-khát-đôn lên ngôi kế vị.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 38, '[SECTION] Vua Khít-ki-gia lâm bệnh và được khỏi
...
[SECTION] Bài ca của vua Khít-ki-gia
...
trong nhà ĐỨC CHÚA,
suốt cả cuộc đời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 39, '[SECTION] Phái đoàn Ba-by-lon (Ba-ben)
...
Cả bầu trời, Người giăng như bức trướng,
và căng ra như căng lều để ở.
(23) Vương hầu khanh tướng, Người cho hóa ra không,
...
và đi mãi mà chẳng chùn chân.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 41, '[SECTION] Vua Ky-rô, khí cụ của ĐỨC CHÚA
...
[SECTION] Thiên Chúa tuyển chọn và phù hộ Ít-ra-en
...
tượng thần vàng bạc của chúng là hơi gió hư không!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 42, '[SECTION] Bài ca Người Tôi Tớ – Bài thứ nhất
...
(7) để mở mắt cho những ai mù lòa,
...
lửa thiêu hủy nó, mà nó chẳng quan tâm.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 43, '[SECTION] ĐỨC CHÚA phù trợ và giải thoát Ít-ra-en
...
[SECTION] ĐỨC CHÚA là Thiên Chúa độc nhất
...
[SECTION] Chống lại Ba-by-lon (Ba-ben)
(14) Đây là lời ĐỨC CHÚA,
Đấng cứu chuộc các ngươi,
...
(15) Chính Ta là ĐỨC CHÚA,
Đức Thánh các ngươi thờ,
Đấng tạo thành Ít-ra-en,
Đấng làm vua cai trị các ngươi.
[SECTION] Những điềm thiêng dấu lạ trong cuộc xuất hành mới
...
[SECTION] Ít-ra-en bội nghĩa vong ân
...
cũng không dâng mỡ béo cho Ta được thỏa dạ no lòng.
...
(26) Hãy nhắc lại cho Ta điều ngươi phiền trách,
...
và bỏ mặc Ít-ra-en cho người đời thóa mạ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 44, '[SECTION] Thiên Chúa giáng phúc cho Ít-ra-en
...
Hỏi có thần nào khác ngoại trừ Ta?
Không có Núi Đá nào, Ta biết chắc là không.
[SECTION] Tượng thần là hư vô
...
[SECTION] Trung thành với ĐỨC CHÚA
...
[SECTION] Thiên Chúa tạo thành thế giới và làm chủ lịch sử
...
và với đền thờ: “Hãy được dựng lên!”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 45, '[SECTION] Vua Ky-rô, khí cụ của Thiên Chúa
...
(6) để từ đông sang tây,
thiên hạ biết rằng
chẳng có thần nào khác,
ngoại trừ Ta.
Ta là ĐỨC CHÚA,
không còn chúa nào khác.
(7) Ta tạo ra ánh sáng
và dựng nên tối tăm,
làm ra bình an
và dựng nên tai họa.
Ta là ĐỨC CHÚA,
...
mưa đức công chính;
đất mở ra đi
cho nẩy mầm ơn cứu độ,
đồng thời chính trực sẽ vươn lên.
Ta là ĐỨC CHÚA,
Ta đã làm điều ấy.
[SECTION] Quyền tối thượng của ĐỨC CHÚA
...
[SECTION] Thiên Chúa làm chủ toàn thể vũ trụ
...
sẽ nhờ ĐỨC CHÚA mà vẻ vang toàn thắng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 46, '[SECTION] Ba-by-lon (Ba-ben) thất thủ
...
và sẽ cho Ít-ra-en được vinh quang rạng rỡ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 47, '[SECTION] Ai ca khóc Ba-by-lon (Ba-ben)
...
Ta sẽ chẳng bao giờ mang thân góa bụa,
không bao giờ là người mẹ mất con.”
Giờ đây, hãy nghe điều này:
(9) Thình lình cả hai tai họa đó,
trong một ngày, sẽ ập xuống trên ngươi:
vừa mất con lại vừa góa bụa.
Chưa hết tai họa này đã đến tai họa khác,
...
không sao cứu mạng khỏi hỏa hào.
...
chẳng có ai cứu được ngươi đâu.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 48, '[SECTION] ĐỨC CHÚA đã tiên báo tất cả
...
(10) Này Ta đã tinh luyện ngươi, không phải như người ta luyện bạc,
...
vinh quang của Ta, Ta không nhường cho ai khác.
[SECTION] ĐỨC CHÚA đã chọn vua Ky-rô
...
tên tuổi ngươi sẽ chẳng bao giờ bị hủy diệt,
chẳng bao giờ bị xóa bỏ khỏi mắt Ta.
[SECTION] Thời lưu đày chấm dứt
...
(22) ĐỨC CHÚA phán:
phường độc ác gian tà không được hưởng bình an.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 49, '[SECTION] Bài ca Người Tôi Tớ – Bài thứ hai
...
[SECTION] Vui ngày trở về
(8) ĐỨC CHÚA phán thế này:
Ta đã nhậm lời ngươi vào thời Ta thi ân,
...
thành lũy ngươi, Ta luôn thấy trước mặt.
(17) Những người tái thiết ngươi thì vội vàng chạy tới,
còn kẻ hủy diệt tàn phá ngươi thì đành phải tháo lui.
...
Đấng cứu chuộc ngươi về chính là Đấng Toàn Năng của Gia-cóp.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 50, '[SECTION] Trừng phạt Ít-ra-en
...
[SECTION] Bài ca Người Tôi Tớ – Bài thứ ba
...
Ai tranh tụng với tôi? Cùng nhau ta hầu tòa!
...
(11) Phần tất cả các ngươi, những ai đã phóng hỏa,
...
các ngươi sẽ nằm xuống trong đớn đau cùng cực.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 51, '[SECTION] Ít-ra-en được tuyển chọn và giáng phúc
...
[SECTION] Đức công chính của Thiên Chúa ngự trị
(4) Hỡi dân Ta,
...
[SECTION] ĐỨC CHÚA an ủi dân Người
...
[SECTION] Giê-ru-sa-lem thức dậy
...
(19) Ngươi đã lâm cảnh họa vô đơn chí,
...
vì lời đe dọa của Thiên Chúa ngươi thờ.
...
làm đường đi cho kẻ qua người lại.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 52, '[SECTION] Giê-ru-sa-lem được giải thoát
...
[SECTION] Bài ca Người Tôi Tớ – Bài thứ tư
(13) Này đây, người tôi tớ của Ta sẽ thành đạt,
...
được hiểu điều chưa nghe nói bao giờ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 53, '(1) Điều chúng ta đã nghe,
ai mà tin được?
...
và can thiệp cho những kẻ tội lỗi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 54, '[SECTION] Giê-ru-sa-lem được phục hồi
...
cũng vậy, nay Ta thề sẽ không còn nổi giận và hăm dọa ngươi đâu.
...
tường trong lũy ngoài, toàn đá quý.
...
(17) Mọi khí cụ được chế ra nhằm chống lại ngươi đều chẳng lợi hại gì;
...
– sấm ngôn của ĐỨC CHÚA.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 55, '[SECTION] Lời mời gọi cuối cùng
...
được ghi nhớ ngàn năm và truyền tụng muôn đời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 56, '[PART] III. PHẦN THỨ BA SÁCH I-SAI-A
[SECTION] Lời hứa dành cho người ngoại bang
...
(5) thì trong nhà và trong tường lũy của Ta,
Ta sẽ cho chúng được lưu danh và có đài kỷ niệm;
như thế còn quý hơn con trai con gái.
Ta sẽ cho tên tuổi chúng trường tồn, không bao giờ bị ai xóa bỏ.
...
(11) Chúng còn là lũ chó đói,
ăn chẳng biết no.
Thế mà chúng lại là mục tử,
thứ mục tử chẳng biết phân biệt gì.
...
ngày mai cũng lại như hôm nay, và còn nhiều hơn nữa.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 57, '(1) Người công chính tiêu vong, thế mà chẳng ai lưu tâm đến;
...
[SECTION] Chống lại việc thờ ngẫu tượng
...
ngươi tự lột trần, leo lên giường, chơi bời thỏa thích,
...
[SECTION] Kẻ nghèo hèn được ơn cứu độ
(14) Có lời rằng:
“Hãy mở đường khai lối,
...
“Phường độc ác gian tà
không được hưởng bình an.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 58, '[SECTION] Cách ăn chay đẹp lòng Thiên Chúa
...
(9) Bấy giờ, ngươi kêu lên, ĐỨC CHÚA sẽ nhậm lời,
...
Chính miệng ĐỨC CHÚA đã phán như vậy.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 59, '[SECTION] Thánh vịnh sám hối
...
[SECTION] Sấm ngôn
(21) Phần Ta, đây là giao ước của Ta với chúng –ĐỨC CHÚA phán–: thần khí của Ta ở trên ngươi, và các lời Ta đặt nơi miệng ngươi sẽ không rời khỏi miệng ngươi, khỏi miệng con cái ngươi, và khỏi miệng cháu chắt ngươi –ĐỨC CHÚA phán–, từ nay cho đến mãi muôn đời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 60, '[SECTION] Vẻ huy hoàng của Giê-ru-sa-lem
...
(10) Con cái khách ngoại kiều sẽ tái thiết thành lũy của ngươi,
...
Ngươi sẽ gọi thành lũy ngươi là “Ơn Cứu Độ”
...
sẽ có ngàn con cháu,
kẻ hèn nhất
thành một dân hùng cường.
Ta, ĐỨC CHÚA, khi đến thời,
Ta sẽ mau thực hiện điều đó.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 61, '[SECTION] Ơn gọi của ngôn sứ
...
làm trổi vang lời ca ngợi trước mặt muôn dân.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 62, '[SECTION] Vẻ huy hoàng của Giê-ru-sa-lem
(1) Vì lòng mến Xi-on,
...
là “Thành không bị bỏ”.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 63, '[SECTION] Xét xử các dân tộc
...
[SECTION] Suy niệm về lịch sử Ít-ra-en
...
là các chi tộc thuộc gia nghiệp của Ngài, xin Ngài mau trở lại.
...
cho núi non rung chuyển trước Thánh Nhan,') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 64, '(1) như lửa đốt củi khô, như lửa làm cho nước sôi sùng sục!
...
Ngài đành nín lặng, để chúng con khổ nhục ê chề?') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'is', 65, '[SECTION] Cuộc xét xử tương lai
...
người ta nói: đừng phá hủy, vì trong đó còn có phúc lành;
cũng vậy, Ta sẽ hành động vì các tôi tớ của Ta,
để không hủy diệt tất cả.”
...
[SECTION] Phán quyết về Giê-ru-sa-lem
...
và lời đe dọa trong ngọn lửa thiêu.
...
Chúng sẽ là đồ ghê tởm cho mọi người phàm.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;