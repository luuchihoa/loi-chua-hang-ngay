...
(12) Đừng khoái chí nhìn ngày anh em ngươi mắc họa.
...
ngươi cũng đừng khoái chí nhìn tai họa của nó
...
Và ĐỨC CHÚA sẽ nắm trọn vương quyền.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;