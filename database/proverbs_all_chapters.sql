...
được yên ổn, chẳng sợ chi tai họa.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 2, '[SECTION] Những phúc lành do khôn ngoan ban tặng
...
phường bất trung sẽ bị trục xuất khỏi quê hương.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 3, '[SECTION] Thái độ đối với ĐỨC CHÚA
...
[SECTION] Niềm vui của người khôn ngoan
...
kẻ khờ dại phải nhục nhã ê chề.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 4, '[SECTION] Để cho Đức Khôn Ngoan hướng dẫn
(1) Hỡi các con,
...
cố giữ chân con khỏi điều xấu xa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 5, '[SECTION] Xa lánh người đàn bà trắc nết – Sống chung thủy
...
vì ngu si quá đỗi, nó sẽ phải lạc đường.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 6, '[SECTION] Sự bảo lãnh thiếu khôn ngoan
...
[SECTION] Người biếng nhác và con kiến
...
lúc nào cũng gieo bất hòa, xung khắc.
(15) Thế nên tai họa sẽ giáng xuống nó thình lình,
bất ngờ nó bị suy sụp, vô phương cứu chữa.
[SECTION] Bảy điều Thiên Chúa ghê tởm
...
[SECTION] Cha tiếp tục nhắn nhủ con
...
có đưa bao quà cáp, cũng một mực chối từ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 7, '(1) Hỡi con, lời thầy, con hãy giữ,
...
xuống ngục sâu thăm thẳm của tử thần.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 8, '[SECTION] Đức Khôn Ngoan tiếp tục kêu gọi
...
[SECTION] Đức Khôn Ngoan tự ca ngợi
...
[SECTION] Đức Khôn Ngoan trong công trình sáng tạo
...
[SECTION] Lời kêu gọi khẩn thiết
...
mọi kẻ ghét ta là yêu cái chết.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 9, '[SECTION] Đức Khôn Ngoan mở tiệc đãi khách
...
[SECTION] Chống hạng người ngoan cố
...
[SECTION] Mụ Khờ Dại cũng lên tiếng mời mọc
...
và thực khách mụ mời lại phải ở trong chốn âm ty sâu thẳm.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 10, '[PART] II. BỘ SƯU TẬP THỨ NHẤT CÁC CHÂM NGÔN CỦA VUA SA-LÔ-MÔN
...
người thẳng thắn rầy la sẽ đem lại an hòa.
...
(29) Đường lối của ĐỨC CHÚA là thành lũy chở che người liêm chính,
...
miệng đứa ác nói toàn chuyện dối gian.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 11, '(1) ĐỨC CHÚA ghê tởm bàn cân gian,
...
(15) Ai bảo lãnh người lạ sẽ chuốc họa vào thân,
...
huống chi là kẻ tội lỗi, đứa ác tâm.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 12, '(1) Yêu lời nghiêm huấn là yêu tri thức,
...
người cổ võ hòa bình được chan chứa niềm vui.
(21) Người công chính không khi nào gặp nạn,
còn ác nhân, tai họa cứ dập dồn.
...
nhưng đường ác nhân đi khiến chúng bị lạc.
...
lối gian tà dẫn đến tử vong.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 13, '(1) Con khôn giữ lời cha nghiêm huấn,
...
người chuyên cần muốn chi cũng được thỏa mãn.
...
(17) Sứ giả gian manh chỉ gây nên tai họa,
...
(25) Chính nhân được ăn no, kẻ ác phải đói bụng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 14, '(1) Phụ nữ khôn ngoan xây dựng cửa nhà,
...
thương xót kẻ khó nghèo là tôn kính Đấng dựng nên người đó.
...
bầy tôi bất tài làm vua thịnh nộ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 15, '(1) Câu đáp dịu dàng khiến cơn giận tiêu tan,
...
còn hơn mâm cao cỗ đầy mà bất hòa bất thuận.
...
đất kẻ góa bụa, Người giữ vững đường ranh.
...
khiêm nhu là đường dẫn đến vinh dự.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 16, '(1) Suy nghĩ lo toan là việc của con người,
...
(28) Kẻ dối gian gây bất hòa tranh chấp,
...
đều bắt nguồn từ ĐỨC CHÚA.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 17, '(1) Thà ăn mẩu bánh khô mà được êm ấm
còn hơn đầy yến tiệc mà nhà cửa bất hòa.
...
nếu biết ngậm môi,
kẻ đó được coi là người thông hiểu.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 18, '(1) Kẻ ích kỷ chạy theo dục vọng,
...
họ cho đó là tường cao lũy dầy.
...
Các cuộc cãi vã tựa như then cài cửa lũy đồn.
...
(24) Có thứ bạn bè gây ra tai họa,
có người thân hữu gắn bó hơn cả anh em.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 19, '(1) Thà nghèo túng mà sống vẹn toàn,
...
và đòn vọt kề lưng đứa ngu si.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 20, '(1) Rượu nồng sinh nhạo báng, men say tạo ồn ào,
...
và roi vọt thấu đến tận cõi lòng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 21, '(1) Trong tay ĐỨC CHÚA, lòng vua tựa dòng nước chảy,
...
và lật nhào đồn lũy chúng cậy trông.
...
tất cả chẳng là gì sánh với ĐỨC CHÚA.
(31) Chiến mã được chuẩn bị cho ngày giao tranh,
nhưng thắng bại thuộc quyền ĐỨC CHÚA.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 22, '(1) Lắm của cải đâu quý bằng danh thơm tiếng tốt,
...
[PART] III. SƯU TẬP NHỮNG LỜI CỦA BẬC KHÔN NGOAN
...
chứ không phục vụ hạng tầm thường.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 23, '(1) Khi con ngồi ăn với kẻ có chức quyền,
...
để tôi lại kiếm thêm ly nữa?”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 24, '(1) Chớ phân bì với quân tội lỗi,
...
chớ ghen tuông cùng phường gian ác.
...
(22) Vì tai họa sẽ giáng xuống bất ngờ,
cả hai sẽ tiêu diệt chúng ra sao, nào có ai lường được?
[PART] IV. SƯU TẬP NHỮNG LỜI KHÁC CỦA BẬC KHÔN NGOAN
...
cảnh bần cùng sẽ đột nhập như người có vũ trang.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 25, '[PART] V. BỘ SƯU TẬP THỨ HAI CÁC CHÂM NGÔN CỦA VUA SA-LÔ-MÔN
...
(8) con đừng vội đem ra trước tòa,
...
chẳng khác nào chùy, gươm và tên nhọn.
...
ví như thành bỏ ngỏ, không tường lũy chở che.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 26, '(1) Tuyết đâu rơi mùa hè, trời đâu mưa mùa gặt,
...
(4) Đừng đáp lại đứa ngu theo cái ngu của nó,
...
và gánh lấy biết bao tai họa.
(7) Đứa dốt mở miệng nói khôn nói ngoan
thì cũng như anh què đi khập khiễng.
(8) Bày tỏ lòng kính trọng đứa ngu
chẳng khác chi cột sỏi vào ná bắn.
(9) Đứa dốt mở miệng nói khôn nói ngoan
...
(19) Kẻ lừa đảo bạn bè, rồi bảo: “Đùa đấy thôi!”
...
miệng ngọt xớt gây đổ vỡ nát tan.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 27, '(1) Chớ huênh hoang tự đắc về ngày mai,
...
(11) Này con, hãy khôn ngoan cho thầy được thỏa dạ
...
(15) Đàn bà lắm điều như nhà dột ngày mưa.
...
cặp mắt con người chẳng bao giờ thỏa.
...
nuôi cả nhà và các tỳ nữ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 28, '(1) Ác nhân trốn chạy dù không ai đuổi bắt,
...
(5) Phường gian ác đâu hiểu lẽ công bằng,
...
thì vinh quang chiếu tỏa nơi nơi,
...
(24) Kẻ bóc lột mẹ cha, rồi bảo: “Đâu có tội vạ gì!”,
...
Kẻ ác sụp đổ, chính nhân lại thêm đông.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 29, '(1) Người được sửa dạy mà cứng đầu cứng cổ
...
(24) Kẻ đồng lõa với tên trộm cắp
...
ác nhân kinh tởm người theo đường chính trực.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 30, '[PART] VI. LỜI CỦA ÔNG A-GUA
...
(6) Đừng thêm thắt chi vào lời Người phán dạy
...
[PART] VII. CHÂM NGÔN CÓ SỐ
(15) Đỉa có hai đứa con gái là: “Cho nữa đi! Cho nữa đi!”
Có ba điều không bao giờ thỏa mãn,
và bốn chuyện không bao giờ nói: “Đủ rồi!”
(16) Đó là: cõi âm ty, lòng dạ son sẻ,
...
(20) Đường của người phụ nữ ngoại tình cũng vậy:
...
và chọc giận sẽ sinh chuyện đôi co.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'cn', 31, '[PART] VIII. LỜI CỦA LƠ-MU-ÊN
...
(3) Đừng hiến sinh lực của con cho phụ nữ,
...
do những việc nàng làm.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;