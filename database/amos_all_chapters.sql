...
[PART] I. ÁN PHẠT CÁC NƯỚC LÁNG GIỀNG VÀ ÁN PHẠT CHÍNH ÍT-RA-EN
[SECTION] Đa-mát
...
(4) Ta sẽ phóng hỏa vào nhà Kha-da-ên
...
(10) nên Ta sẽ phóng hỏa lên tường thành Tia,
và lửa sẽ thiêu rụi đền đài ở đó.
[SECTION] Ê-đôm
...
(12) nên Ta sẽ phóng hỏa vào Tê-man,
...
cả vua lẫn quan cùng một lúc – ĐỨC CHÚA phán như vậy.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'am', 2, '[SECTION] Mô-áp
...
INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'am', 3, '[PART] II. CẢNH CÁO VÀ ĐE DỌA ÍT-RA-EN
[SECTION] Tuyển chọn và trừng phạt
...
[SECTION] Không cưỡng lại được ơn gọi ngôn sứ
...
[SECTION] Sa-ma-ri đồi trụy sẽ bị diệt vong
...
[SECTION] Chống Bết Ên và những tòa nhà sang trọng
...
lâu đài dinh thự cũng tan hoang – sấm ngôn của ĐỨC CHÚA.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'am', 4, '[SECTION] Tố cáo các mệnh phụ vùng Sa-ma-ri
(1) Hãy nghe lời này,
...
[SECTION] Ít-ra-en vẫn ảo tưởng, không chịu sám hối nên bị trừng phạt
...
danh hiệu của Người là ĐỨC CHÚA, Thiên Chúa các đạo binh.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'am', 5, '[SECTION] Than khóc Ít-ra-en
...
[SECTION] Không hoán cải thì không thể được cứu độ
...
[SECTION] Chống lại kiểu phụng tự hình thức
...
– ĐỨC CHÚA phán như vậy,
danh Người là Thiên Chúa các đạo binh.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'am', 6, '[SECTION] Cuộc sống an toàn giả tạo của những người cầm quyền
...
họ sẽ đều chết cả.
(10) Một người bà con khiêng thi thể ra khỏi nhà mà hỏa thiêu.
...
từ Cửa Ải Kha-mát cho đến suối A-ra-va.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'am', 7, '[PART] III. CÁC THỊ KIẾN
[SECTION] Thị kiến thứ nhất: châu chấu
...
[SECTION] Thị kiến thứ ba: dây dọi
...
Còn Ta, Ta sẽ đứng dậy dùng gươm mà chống lại nhà Gia-róp-am.”
[SECTION] Xung đột với A-mát-gia. Ông A-mốt bị trục xuất khỏi Bết Ên.
...
và Ít-ra-en sẽ bị đày xa quê cha đất tổ.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'am', 8, '[SECTION] Thị kiến thứ tư: giỏ trái cây mùa hạ
(1) ĐỨC CHÚA là Chúa Thượng đã cho tôi thấy như sau:
...
[SECTION] Chống bọn người gian lận và đầu cơ
...
[SECTION] Báo trước hình phạt: tăm tối và tang thương
...
mà không gặp được.
[SECTION] Lại báo trước hình phạt
...
những kẻ đó sẽ té nhào, không đứng dậy được nữa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'am', 9, '[SECTION] Thị kiến thứ năm: Đền Thờ bị sụp đổ
...
Ta sẽ đưa mắt nhìn chúng để giáng họa
...
danh Người là ĐỨC CHÚA.
[SECTION] Mọi người tội lỗi sẽ phải chết
...
“Tai họa sẽ chẳng đến gần, nó sẽ không ập xuống chúng ta đâu!”,
chúng sẽ chết vì gươm hết thảy.
[PART] IV. VIỄN TƯỢNG PHỤC HƯNG VÀ PHỒN THỊNH THỜI THIÊN SAI
...
(14) Ta sẽ đổi vận mệnh của Ít-ra-en dân Ta:
...
– ĐỨC CHÚA là Thiên Chúa của ngươi phán như vậy.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;