...
[SECTION] Than vãn vì đất nước hoang tàn
...
[SECTION] Kêu gọi sám hối và cầu nguyện
...
vì không còn cỏ ăn.
Cả đàn cừu cũng bị chung tai họa.
...
và lửa hồng đã thiêu hết bãi cỏ trong hoang địa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'ge', 2, '[SECTION] Báo động về Ngày của ĐỨC CHÚA
...
[SECTION] Nạn châu chấu hoành hành
(3) Đi trước dân này là khối lửa thiêu,
theo sau chúng là hỏa hào bốc cháy.
...
(9) Chúng đổ xô vào thành, chạy trên tường lũy;
chúng leo lên nhà, vào qua cửa sổ, chẳng khác chi kẻ trộm.
[SECTION] Thị kiến về Ngày của ĐỨC CHÚA
...
“Lạy ĐỨC CHÚA, xin rủ lòng thương xót dân Ngài!
...
[SECTION] Thị kiến về thời phồn vinh
...
(26) Các ngươi sẽ được ăn no nê thỏa thích,
...
Và dân Ta sẽ chẳng bao giờ xấu hổ nữa.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'ge', 3, '[PART] II. THỜI MỚI VÀ NGÀY CỦA ĐỨC CHÚA
[PART] 1. BAN THẦN KHÍ
...
(4) Mặt trời sẽ trở nên tối tăm, mặt trăng hóa thành máu,
trước khi Ngày của ĐỨC CHÚA xuất hiện,
Ngày vĩ đại, kinh hoàng.
(5) Bấy giờ, hết những ai kêu cầu danh ĐỨC CHÚA sẽ được ơn cứu độ,
...
trong số những kẻ còn sống sót.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'ge', 4, '[PART] 2. CÁC DÂN TỘC BỊ XÉT XỬ
[SECTION] Những chủ đề chung
...
[SECTION] Buộc tội người Phê-ni-xi và người Phi-li-tinh
...
ĐỨC CHÚA đã phán như vậy.”
[SECTION] Triệu tập các dân tộc
(9) Giữa các dân các nước, hãy cao giọng loan báo điều sau đây:
Hãy thánh hóa mình để sẵn sàng ứng chiến,
...
[PART] 3. THỜI KỲ CỰC THỊNH CỦA ÍT-RA-EN PHỤC HƯNG
...
ĐỨC CHÚA ngự tại Xi-on.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;