...
[SECTION] Lòng kính sợ Thiên Chúa
...
[SECTION] Khôn ngoan và ngay thẳng
(25) Trong các kho tàng của khôn ngoan,
có nhiều ẩn dụ thâm thúy,
...
và lòng con đầy những mưu gian.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 2, '[SECTION] Kính sợ Đức Chúa trong thử thách gian truân
...
và những ai kính mến Người thì no thỏa Lề Luật.
...
thì cũng lân tuất như vậy.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 3, '[SECTION] Nghĩa vụ đối với cha mẹ
...
[SECTION] Bác ái đối với người nghèo
(30) Nước dập tắt lửa hồng, bố thí đền bù tội lỗi.
(31) Ai đền ơn đáp nghĩa là biết lo xa,
lúc sa cơ, người ấy sẽ tìm được nơi nương tựa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 4, '(1) Con ơi,
...
[SECTION] Khôn ngoan là nhà giáo dục
...
(31) Đừng xòe tay ra nhận, rồi nắm lại khi phải cho đi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 5, '[SECTION] Giàu sang và tự đắc
...
đang là bạn, chớ trở nên thù.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 6, '(1) Quả vậy, bị mang tiếng thì thật là nhục nhã và ô danh,
...
(6) Ước chi có nhiều người sống hòa nhã với con;
...
và cho con được khôn ngoan như lòng sở nguyện.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 7, '[SECTION] Một số lời khuyên
...
nhưng đừng ra mặt vui vẻ xuề xòa.
...
rồi của lễ thánh hóa và phần tinh hoa trích từ của thánh.
[SECTION] Những kẻ nghèo và người đau khổ
...
thì mãi mãi con sẽ không phạm tội.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 8, '[SECTION] Thận trọng thì suy đi nghĩ lại
...
(14) Đừng tranh kiện với quan tòa,
tòa sẽ vì danh dự của ông mà xử cho ông thắng.
...
đừng tưởng làm như vậy là người ta thích.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 9, '[SECTION] Đàn bà con gái
...
người nói năng láu táu, ai cũng ghét cũng chê.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 10, '[SECTION] Việc cai trị
...
và phá hủy đến tận nền trái đất.
(17) Người đã loại chúng ra khỏi cõi đời và hủy diệt chúng,
đã xóa sạch chúng khỏi ký ức người đời.
(18) Con người được dựng nên không phải để kiêu ngạo,
con cái của đàn bà được sinh ra không phải để giận dữ.
[SECTION] Những người đáng trọng
...
[SECTION] Đức khiêm nhường và lòng chân thật
...
thì khi nghèo còn bị khinh biết mấy?') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 11, '[SECTION] Đừng xem mặt bắt hình dong
...
[SECTION] Tin cậy vào một mình Thiên Chúa
...
[SECTION] Coi chừng người gian ác
...
khiến con thành xa lạ với thân quyến của con.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 12, '[SECTION] Làm ơn làm phúc
...
nói về con đủ điều mà để lộ chân tướng nó.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 13, '[SECTION] Với đồng trang đồng lứa
...
(18) Hòa bình sao được giữa chó rừng và chó nhà?
Và hòa bình sao được giữa kẻ giàu sang với người lam lũ?
...
Phải lao tâm khổ tứ lắm mới làm được các dụ ngôn.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 14, '[SECTION] Hạnh phúc thật
...
(16) Hãy cho và nhận, hãy làm cho tâm hồn mình khuây khỏa,
...
(18) Như cành lá trên cây rậm rạp: lá rụng xuống, lá lại mọc ra,
...
[SECTION] Hạnh phúc của người khôn ngoan
...
và trong vinh quang của khôn ngoan, nó sẽ cư ngụ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 15, '(1) Điều đó, kẻ kính sợ Đức Chúa sẽ thi hành,
...
(7) Những kẻ ngu dốt sẽ không chiếm được khôn ngoan,
...
(14) Từ nguyên thủy, chính Chúa đã làm nên con người,
...
cũng không cho phép ai phạm tội.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 16, '[SECTION] Kẻ gian ác bị nguyền rủa
...
Người xét xử ai nấy tùy theo việc họ làm.
...
[SECTION] Chắc chắn có thưởng phạt
...
[SECTION] Con người trong công trình tạo dựng
...
các công trình của Người đã có từ nguyên thủy,
...
và chúng sẽ phải trở về đất.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 17, '(1) Đức Chúa lấy đất mà tạo ra con người,
...
[SECTION] Thiên Chúa là thẩm phán
...
còn nhân loại hết thảy chỉ là đất là tro.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 18, '[SECTION] Thiên Chúa cao cả
...
[SECTION] Cách thức trao tặng
(15) Con ơi, khi làm ơn, con đừng trách móc;
...
(31) Nếu con thỏa mãn các tham vọng của mình,
thì con làm cho kẻ thù con thích thú.
(32) Đừng tìm vui trong khoái lạc xa hoa,
đừng cấu kết với bọn nào như thế.
(33) Đừng vay mượn để tiệc tùng mà hóa ra nghèo,
và không còn đồng xu dính túi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 19, '(1) Một người thợ say sưa sẽ không giàu có được,
...
[SECTION] Kiểm chứng điều nghe nói
...
(17) Hãy điều tra người bên cạnh con trước khi hăm dọa nó,
và dành chỗ cho Luật của Đấng Tối Cao.
[SECTION] Khôn ngoan thật, khôn ngoan giả
...
và dáng đi bộc lộ con người ấy.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 20, '[SECTION] Nên nói hay làm thinh
(1) Có lời trách mắng không đúng lúc,
có kẻ thinh lặng mà lại biết điều.
(2) Thà trách mắng còn hơn giận dữ.
(3) Người thú tội thì tránh được bao hệ lụy.
...
vẫn hơn kẻ che giấu sự khôn ngoan.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 21, '[SECTION] Các thứ tội
...
còn kẻ sa đọa thì bực mình và bỏ lại sau lưng.
...
như còng khóa tay phải.
(20) Người ngu cười hô hố,
còn người sáng trí họa mới mỉm cười.
...
và bị hàng xóm láng giềng ghét bỏ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 22, '[SECTION] Kẻ lười biếng
...
(6) Bảo ban không đúng lúc tựa như hòa nhạc giữa đám tang,
nhưng roi vọt và lời răn đe là khôn ngoan mọi lúc.
[SECTION] Khôn ngoan và ngu dại
...
(16) Như cột kèo chắc chắn trong tòa nhà,
...
(22) Nếu con lỡ nặng lời với bạn, đừng lo sợ: con có thể giải hòa.
...
để khi nó thịnh vượng, con cũng được no thỏa.
...
(26) Và nếu hắn có gây họa cho tôi,
...
và lưỡi tôi không làm tôi vong mạng?') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 23, '(1) Lạy Đức Chúa là Cha và là Chúa Tể đời con,
...
(6) xin chớ để thói ăn chơi trụy lạc thống trị con,
...
[SECTION] Những lời nói khiếm nhã
...
sẽ chẳng tắt cho đến khi được thỏa mãn.
Người mê đắm xác thịt
sẽ chẳng ngưng cho đến khi bị lửa thiêu hủy.
...
[SECTION] Người đàn bà ngoại tình
...
nỗi nhục của thị không thể xóa nhòa.
(27) Người đời sau sẽ biết rằng:
Không gì cao quý bằng kính sợ Đức Chúa
và chẳng có chi ngọt ngào bằng
tuân giữ những lệnh Đức Chúa truyền.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 24, '[SECTION] Diễn từ của Đức Khôn Ngoan
...
[SECTION] Đức Khôn Ngoan và Lề Luật
...
nhưng còn vì mọi người muốn tìm kiếm khôn ngoan.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 25, '[SECTION] Châm ngôn
(1) Có ba điều tôi hết lòng ao ước,
cả ba đều đẹp lòng Đức Chúa và người ta:
anh em hòa thuận, láng giềng thân thiết,
...
thì con hãy đoạn tuyệt với nó.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 26, '(1) Phúc thay ai cưới được vợ hiền,
...
và trong mọi chuyện đó, chính cái lưỡi đã gieo tai rắc họa.
...
[SECTION] Những chuyện đáng buồn
...
[SECTION] Việc buôn bán
(29) Làm thương mại khó tránh khỏi tham lam,
đi buôn bán không thoát được tội lỗi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 27, '(1) Vì ham lợi mà nhiều người mắc lỗi,
...
người đó sẽ sa bẫy,
sẽ bị đau khổ giày vò ngay khi còn sống.
[SECTION] Thù hận
(30) Oán hờn và giận dữ là những điều ghê tởm,
về chuyện đó kẻ tội lỗi có biệt tài.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 28, '(1) Kẻ báo thù sẽ chuốc lấy báo thù của Đức Chúa,
...
(9) Người tội lỗi làm cho bè bạn nên bất hòa,
gây chia rẽ giữa những người hòa thuận.
(10) Củi khô thì lửa bốc, càng nóng càng cãi hăng,
càng khỏe càng nóng tính, càng giàu càng dễ giận.
...
gây chia rẽ giữa bao người đang hòa thuận.
...
miệng con phải như là cửa có khóa.
(26) Hãy ý tứ, đừng để lỡ lời,
kẻo vấp ngã trước kẻ rình rập con.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 29, '[SECTION] Cho vay mượn
...
(20) Hãy nâng đỡ kẻ khác tùy sức con,
nhưng cẩn thận giữ mình kẻo ngã.
[SECTION] Ăn nhờ ở đậu
...
hoặc bị mắng nhiếc là đứa nợ nần.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 30, '[SECTION] Giáo dục
...
thưởng thức được đồ ăn thức uống.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 31, '[SECTION] Của cải
...
(5) Đã ham tiền không sao công chính được,
...
(30) Ma men khiến đứa ngu nổi khùng mà chuốc họa vào thân:
...
cũng đừng đòi nợ nó kẻo nó nổi sùng.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 32, '[SECTION] Tiệc tùng
(1) Được đặt làm chủ tọa ư? Con đừng có lên mặt:
...
rồi lãnh triều thiên thưởng tài tổ chức.
(3) Nếu là bô lão, xin cứ phát biểu, đó là điều hợp lý hợp tình.
Xin cứ nói như ngài hiểu biết,
nhưng xin đừng cản trở việc đàn ca.
(4) Nhạc đang tấu thì xin đừng thao thao bất tuyệt,
...
(7) Nếu còn trai trẻ, hãy nói lúc cần.
Và khi được mời, cũng chỉ nói hai lần là tối đa.
(8) Hãy nói cho gọn, ít lời, nhiều ý,
làm như kẻ vừa quán triệt vấn đề, vừa biết nín thinh.
(9) Giữa hàng quyền chức, con đừng làm như kẻ bằng vai;
và khi người khác nói, con chớ có bô bô cái miệng.
(10) Như chớp lòe lên trước khi sấm nổ rền,
mối thiện cảm cũng đón chờ con người khiêm tốn.
(11) Tan tiệc thì đứng lên, đừng ngồi nán lại.
Về nhà ngay, chớ có la cà.
(12) Tại nhà, hãy giải trí vui chơi và làm chi tùy thích,
nhưng đừng ăn nói kiêu căng mà mang tội.
(13) Về mọi chuyện trên đây, hãy ca ngợi Đấng tạo thành con,
Đấng ban cho con dồi dào ân phúc.
[SECTION] Kính sợ Thiên Chúa
(14) Kẻ kính sợ Đức Chúa thì đón nhận lời giáo huấn.
Ai từ sáng sớm đã kiếm tìm Người, sẽ được đoái thương.
(15) Ai tìm hiểu Lề Luật sẽ thấm nhuần Lề Luật,
còn với kẻ giả hình, Lề Luật trở thành cớ vấp ngã.
(16) Ai kính sợ Đức Chúa sẽ nhận ra lẽ phải;
việc tốt họ làm sẽ rực rỡ như ánh quang.
(17) Người tội lỗi khước từ lời khiển trách,
tìm đủ lẽ để làm theo ý mình.
(18) Người biết suy nghĩ không coi thường ý kiến kẻ khác.
Quân ngoại bang và phường tự đắc
thì chẳng biết sợ hãi là gì.
(19) Đừng hành động mà không suy nghĩ,
...
(23) Trong mọi việc làm, hãy biết tự tin,
đó cũng là tuân giữ mệnh lệnh.
(24) Ai tin tưởng Lề Luật thì gắn bó với lệnh truyền.
Kẻ cậy trông Đức Chúa sẽ chẳng hề thua thiệt.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 33, '(1) Ai kính sợ Đức Chúa sẽ không gặp tai ương,
có bị thử thách, họ cũng thoát khỏi.
(2) Người khôn thì không ghét bỏ Lề Luật,
...
(5) Lòng dạ kẻ ngu đần ví tựa bánh xe.
Lý luận của nó như trục xe quay tít.
(6) Kẻ ưa thích châm chọc bạn bè
khác nào con ngựa giống, nó vẫn hí..., dù người cỡi là ai.
[SECTION] Hoàn cảnh chênh lệch
(7) Tại sao lại có ngày này trọng hơn ngày khác,
...
(9) Có những ngày Người đề cao và thánh hóa,
cũng có những ngày Người kể vào số ngày thường.
(10) Mọi người đều bởi đất,
cả A-đam cũng bởi đất mà được tạo thành.
(11) Do thượng trí, Đức Chúa đã phân biệt kẻ này người nọ,
đã ấn định đường đời họ khác nhau.
(12) Kẻ thì được Người nâng cao và giáng phúc,
kẻ thì được Người thánh hóa và cho ở bên,
còn kẻ khác bị Người nguyền rủa và hạ xuống thấp,
lật nhào họ khỏi chỗ đứng của họ.
(13) Như nắm đất thó anh thợ gốm cầm trong tay,
...
(14) Có dữ thì cũng có lành, có chết thì cũng có sống.
Cũng thế, có người đạo hạnh thì cũng có kẻ tội lỗi.
(15) Vậy hãy nhìn ngắm mọi công trình của Đấng Tối Cao,
từng đôi một, công trình đối lại công trình.
(16) Phần tôi, kẻ đến sau cùng, tôi cũng đã thức khuya,
như người đi mót đến sau thợ hái trái.
(17) Nhờ phúc lộc Đức Chúa, tôi đã theo kịp,
và, như mọi tay thợ, tôi đã chất nho đầy bồn.
(18) Hãy hiểu cho rằng tôi vất vả đâu phải cho mình tôi,
...
(21) Bao lâu còn sống, còn chút hơi tàn,
đừng phó mặc thân con cho người nào bất cứ.
(22) Vì thà để con cái nài xin con,
còn hơn con phải ngóng trông bàn tay chúng.
(23) Trong mọi việc con làm, hãy nắm quyền điều khiển,
đừng để thanh danh con bị lu mờ.
(24) Đến ngày kết thúc cuộc đời, lúc con phải chết,
khi ấy hãy phân chia gia tài.
[SECTION] Nô lệ
(25) Cỏ rơm, roi đòn và đồ nặng phải chở, đó là phần của lừa.
Bánh mì, kỷ luật và công việc phải làm là phần của gia nhân.
(26) Dùng kỷ luật ép nó làm lụng, con sẽ được nghỉ ngơi.
Nếu nới tay với nó, nó sẽ tìm tự do.
(27) Ách và dây cương mới ghì được cổ lừa,
cực hình và những cuộc tra khảo
mới gò được đứa ở bất lương.
(28) Phải thúc nó làm việc kẻo nó ra lười biếng,
vì, “nhàn cư vi bất thiện.”
(29) Hãy bắt nó làm những việc nó phải làm;
nó không tuân lệnh thì cùm chân nó lại.
(30) Nhưng đừng nghiệt ngã với bất cứ người nào,
và đừng làm gì trái lẽ phải.
(31) Nếu con chỉ có một gia nhân, hãy coi nó như bản thân mình,
vì giá sở hữu nó là xương máu.
(32) Nếu con chỉ có một gia nhân, hãy lấy tình anh em mà đối xử,
vì con cần nó như cần chính sự sống mình.
(33) Nếu vì con xử tệ mà nó bỏ trốn,
thì biết đường nào mà kiếm cho ra?') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 34, '[SECTION] Mộng mơ
...
(6) Nếu đó không phải do Đấng Tối Cao
...
[SECTION] Một ngày đàng, một sàng khôn
...
(12) Đã nhiều lần tính mạng tôi lâm nguy,
...
Người ban sức khỏe, sự sống và phúc lành.
[SECTION] Các hy lễ
...
Hạ mình kiểu đó, nào được ích lợi gì?') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 35, '[SECTION] Lề Luật và hy lễ
...
hay tiếng than van của người góa bụa.
(15) Nước mắt quả phụ lại không giàn giụa trên gò má,
...
(19) Đức Chúa không trì hoãn,
không bắt họ đợi lâu.
(20) Sẽ đến lúc Người đập gãy lưng bọn tàn ác,
và báo oán chư dân.
(21) Sẽ đến lúc Người tiễu trừ lũ ngạo ngược,
đập tan vương trượng bọn ác nhân.
(22) Sẽ đến lúc Người trả cho ai nấy theo việc họ làm,
và xét xử hành động của người ta theo ý hướng của họ.
(23) Sẽ đến lúc Người phân xử cho dân Người,
khiến họ vui mừng vì được Người thương xót.
(24) Đẹp thay lòng thương xót của Người giữa buổi gian truân,
khác chi mây trời đổ mưa thời nắng hạn!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 36, '[SECTION] Cầu cho Ít-ra-en được giải thoát và phục hưng
...
(11) Lạy Đức Chúa, xin rủ lòng thương Ít-ra-en
...
(27) Đàn ông không tổ ấm cũng vậy thôi: tối đến thì bạ đâu trú đấy.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 37, '[SECTION] Bạn bè giả dối
(1) Bạn bè nào chẳng nói: “Đây cũng chỗ thân thiết mà!”
Nhưng có người chỉ mang danh là bạn.
(2) Không buồn chết được sao
khi bạn bè thân hữu lại hóa nên thù địch?
...
còn ai cẩn thận thì được sống lâu.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 38, '[SECTION] Nghề thuốc và bệnh tật
...
dù họ chỉ quan tâm đến công việc trong ngành nghề của họ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 39, '[SECTION] Kinh sư
...
và sẽ thỏa lòng khi an giấc ngàn thu.
[SECTION] Lời mời gọi ngợi khen Thiên Chúa
...
(14) như cây hương tỏa mùi thơm ngào ngạt,
...
(34) Không có lý do gì để nói: ‘Cái này tệ hơn cái kia’,
vì đến lúc bất cứ cái gì cũng sẽ được nhìn nhận là tốt.”
(35) Vậy giờ đây, hãy hết lòng và lớn tiếng hát ca
mà chúc tụng thánh danh Đức Chúa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 40, '[SECTION] Kiếp người khốn khổ
...
(10) Tất cả những thứ đó đã được tạo nên cho quân vô đạo,
...
nhưng tâm địa hắn thì như lò lửa.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 41, '[SECTION] Chết
(1) Hỡi tử thần, nhớ đến ngươi thật là cay đắng
đối với ai đang an hưởng tài sản của mình,
đối với người không phải âu lo,
người thành công trong hết mọi việc,
người còn khỏe mạnh để hưởng thú vui.
(2) Hỡi tử thần, phán quyết của ngươi hay thật
đối với kẻ bần cùng, với người thiếu sức khỏe,
...
(4) Đó là điều Đức Chúa quyết định cho hết mọi người phàm.
...
(18) trước mặt những ai cầm quyền xét xử vì hành vi phạm pháp,
...
(22) vì gặp gái bán dâm mà nhìn chòng chọc,
...
(26) vì học lại cho người khác điều đã nghe,
hay tiết lộ những điều bí mật.
(27) Có vậy con mới biết
thế nào là xấu hổ thật
và sẽ gây được thiện cảm với mọi người.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 42, '(1) Còn về những chuyện sau đây, con đừng xấu hổ,
...
ở đâu có lắm người tắt mắt, phải khóa sao cho chặt.
...
[SECTION] Những nỗi lo của người cha đối với con gái
...
[PART] II. VINH QUANG CỦA THIÊN CHÚA
[PART] 1. TRONG THIÊN NHIÊN
...
(16) Mặt trời tỏa sáng nhìn xuống muôn loài,
...
nhìn ngắm vinh quang của Người, ai mà chán được?') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 43, '[SECTION] Mặt trời
...
đốt cháy cả núi đồi, tỏa hơi nóng bỏng,
chiếu rọi những ánh nắng chói chang, làm lóa con mắt.
...
Khắp bầu trời, vầng trăng tỏa sáng.
[SECTION] Các ngôi sao
...
[SECTION] Những điều kỳ diệu trong thiên nhiên
...
(17a) Cõi đất quằn quại vì tiếng sấm của Người.
(16) Người nhìn, núi non liền rung chuyển,
Người muốn là gió nam,
(17b) bão táp phương bắc và gió xoáy liền thổi tới.
...
(29) Đức Chúa khả úy và rất mực cao cả,
...
và ban tặng khôn ngoan cho người đạo hạnh.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 44, '[PART] 2. TRONG LỊCH SỬ
[SECTION] Ca ngợi các bậc tổ tiên
...
[SECTION] Ông I-xa-ác và ông Gia-cóp
...
và phân phát cho mười hai chi tộc.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 45, '[SECTION] Ông Mô-sê
...
(4) Người thánh hóa ông vì ông tín thành và nhân hậu,
...
khăn ngực đựng thẻ xăm phán quyết, U-rim và Tum-mim,
...
và vinh quang của các ngài được lưu truyền cho con cháu.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 46, '[SECTION] Ông Giô-suê
...
nói lời sấm để xóa đi sự gian ác của dân.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 47, '[SECTION] Ngôn sứ Na-than
...
(3) Ông chơi giỡn với sư tử như với dê tơ,
...
(11) Đức Chúa đã xóa bỏ tội lỗi của ông
...
vì hiếu hòa, ngài được người người mến chuộng.
...
cũng không hủy bỏ lời nào đã hứa.
...
cho đến khi hình phạt giáng xuống trên họ.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 48, '[SECTION] Ngôn sứ Ê-li-a
...
[SECTION] Bất trung và hình phạt
...
mãi cho tới muôn đời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 49, '[SECTION] Vua Giô-si-gia
...
[SECTION] Các vua và các ngôn sứ cuối cùng
...
(6) Chúng thiêu hủy thành được tuyển chọn, nơi có Đền Thờ,
...
để nhổ, để phá và để hủy, nhưng cũng để xây và để trồng.
...
[SECTION] Ông Dơ-rúp-ba-ven và ông Giê-su-a
...
[SECTION] Các tổ phụ đầu tiên
(16) Các ông Sêm và Sết được người đời ca tụng;
nhưng trong số sinh linh được tạo thành,
ông A-đam chiếm chỗ ưu việt.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 50, '[SECTION] Thượng tế Si-môn
...
(8) Ông ví như đóa hồng tươi nở giữa mùa xuân,
...
(18) Đoàn ca viên hát bài ca ngợi,
...
sẽ chiếu soi đường nẻo họ đi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hc', 51, '[SECTION] Thánh thi tạ ơn
...
[SECTION] Thánh thi: Tìm đức khôn ngoan
...
Đó là lời khôn ngoan của ông Giê-su, con ông Xi-ra.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;