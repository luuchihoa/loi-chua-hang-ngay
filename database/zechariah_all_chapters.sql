...
[SECTION] Thị kiến thứ ba: người đo
...
[SECTION] Hai lời kêu gọi dân lưu đày
...
bởi vì Người tỉnh giấc và ra khỏi Nơi Thánh của Người.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dcr', 3, '[SECTION] Thị kiến thứ bốn: mặc y phục cho ông Giê-su-a
...
(8) Có lời ĐỨC CHÚA phán với tôi rằng: (9) Chính tay Dơ-rúp-ba-ven đã đặt nền móng cho Đền Thờ này và cũng chính tay nó sẽ hoàn tất. Và các người sẽ nhận biết rằng ĐỨC CHÚA các đạo binh đã phái tôi đến với các người. (10a) Vậy ai dám khinh thường bước khởi đầu khiêm tốn của công việc này? Người ta sẽ hân hoan khi nhìn thấy viên đá được tuyển lựa trong tay Dơ-rúp-ba-ven.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dcr', 5, '[SECTION] Thị kiến thứ sáu: cuốn sách bay
...
[SECTION] Thị kiến thứ bảy: người đàn bà trong cái thùng
(5) Thần sứ đã nói với tôi tiến ra bảo tôi: “Hãy ngước mắt lên mà xem cái gì đang hiện ra kia.” (6) Tôi hỏi: “Thưa ngài, cái gì vậy?” Người đáp: “Cái thùng hiện ra đó.” Người nói tiếp: “Đó là tội lỗi của dân cư toàn xứ này.” (7) Và này: cái nắp chì được nhấc lên; có một mụ đàn bà đang ngồi trong cái thùng. (8) Người bảo: “Tội ác đó.” Rồi thần sứ lại ấn mụ ta vào cái thùng và lấy tảng chì đậy lên trên. (9) Tôi ngước mắt lên và thấy một thị kiến. Này, có hai phụ nữ tiến ra, cánh họ tung bay trong gió; họ có cánh như cánh hạc. Họ nhấc bổng cái thùng lên không trung. (10) Bấy giờ tôi hỏi vị thần sứ đã nói với tôi: “Họ đem cái thùng đi đâu vậy?” (11) Người đáp: “Đem sang đất Sin-a để xây cho nó một ngôi đền, và khi xây xong sẽ đặt nó ở đó, trên một cái bệ.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dcr', 6, '[SECTION] Thị kiến thứ tám: chiến xa
...
[SECTION] Trả lời về vấn đề ăn chay
...
[SECTION] Viễn ảnh ơn cứu độ thời Đấng Mê-si-a
...
(23) ĐỨC CHÚA các đạo binh phán thế này: Trong những ngày ấy, mười người đàn ông thuộc mọi ngôn ngữ trong các dân tộc sẽ níu lấy áo của một người Giu-đa mà nói: “Chúng tôi muốn đi với anh em, vì chúng tôi đã nghe biết rằng Thiên Chúa ở với anh em.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dcr', 9, '[PART] PHẦN THỨ HAI
(1) Lời sấm.
[SECTION] Đất mới
...
và rượu mới làm cho thiếu nữ được vui tươi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dcr', 10, '[SECTION] Trung thành với ĐỨC CHÚA
...
[SECTION] Ít-ra-en được giải phóng và được trở về
...
Tất cả (5) chúng sẽ nên như những anh hùng,
...
nhân danh Người, chúng sẽ tiến đi. Sấm ngôn của ĐỨC CHÚA.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dcr', 11, '(1) Hỡi Li-băng, hãy mở tung các cửa,
...
chúng thưa lại: “ĐỨC CHÚA là Thiên Chúa của chúng tôi.”') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'dcr', 14, '[SECTION] Cuộc chiến thời cánh chung. Vẻ huy hoàng của Giê-ru-sa-lem.
