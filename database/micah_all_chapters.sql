...
[SECTION] Bài ai ca khóc các thành miền đất thấp
...
vì tai họa từ ĐỨC CHÚA giáng xuống
...
thương cho chúng đã phải xa ngươi mà đi đày.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'mk', 2, '[SECTION] Chống những kẻ trục lợi
...
sẽ cất lên bài ca than vãn: “Chúng tôi đã bị hủy diệt hoàn toàn,
...
[SECTION] Ngôn sứ loan báo điều bất hạnh
...
ĐỨC CHÚA, Vua của chúng đi qua trước, chính Người sẽ dẫn đầu.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'mk', 3, '[SECTION] Chống các thủ lãnh áp bức dân
...
[SECTION] Chống các ngôn sứ hám lợi
...
[SECTION] Báo cho nhà chức trách về cảnh điêu tàn của Xi-on
...
Tai họa sẽ chẳng giáng xuống chúng ta đâu!”
(12) Bởi vậy, chính vì các ngươi lầm lỗi
mà Xi-on sẽ thành ruộng cày,
Giê-ru-sa-lem nên chốn tan hoang,
và núi Đền Thờ hóa ra nơi cao rậm rạp.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'mk', 4, '[PART] II. CÁC LỜI HỨA VỚI XI-ON
[SECTION] Triều đại tương lai của ĐỨC CHÚA ở Xi-on
...
[SECTION] Đàn chiên tản mác được tập hợp ở Xi-on
...
[SECTION] Xi-on bị bao vây, lưu đày và được giải thoát
...
[SECTION] Các nước bị đập tan ở Xi-on
...
[SECTION] Nguy khốn và vinh quang của vương triều Đa-vít
(14) Bây giờ, hỡi con gái hiếu chiến, hãy rạch mình;
chúng vây hãm tấn công ta,
lại dùng gậy đánh vào má vị thẩm phán Ít-ra-en.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'mk', 5, '(1) Phần ngươi, hỡi Bê-lem Ép-ra-tha,
...
[SECTION] Người sẽ chiến thắng Át-sua
(4) Chính Người sẽ đem lại hòa bình.
Khi Át-sua xâm nhập xứ sở và giày đạp đất nước chúng ta,
...
[SECTION] Vai trò tương lai của số còn sót lại giữa chư dân
...
[SECTION] ĐỨC CHÚA sẽ loại bỏ mọi sức quyến rũ
(8) Xin Ngài giơ tay đánh phạt quân thù
và mọi thù địch của Ngài phải tiêu vong.
(9) Trong ngày ấy, sấm ngôn của ĐỨC CHÚA, điều này sẽ xảy ra:
Ta sẽ cho ngựa của ngươi biến khỏi xứ,
sẽ hủy diệt xe trận của ngươi.
(10) Ta sẽ phá hủy các thành trong xứ
...
để báo thù chư dân đã không chịu nghe lời Ta.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'mk', 6, '[PART] III. ÍT-RA-EN LẠI BỊ KIỆN CÁO, KHIỂN TRÁCH VÀ ĐE DỌA
[SECTION] ĐỨC CHÚA kiện cáo dân Người
...
[SECTION] Chống sự gian giảo của dân thành
...
(14) Phần ngươi, ngươi sẽ ăn mà không được no thỏa,
...
các ngươi sẽ phải chuốc lấy nỗi nhục của dân Ta.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'mk', 7, '[SECTION] Bất công ở khắp nơi
...
[SECTION] Lời sấm tiên báo ngày hồi phục
...
[SECTION] Cầu xin cho các nước phải hỗn độn
...
Từ trong đồn lũy, chúng sẽ run rẩy kéo nhau ra
mà đến với ĐỨC CHÚA là Thiên Chúa chúng ta.
Chúng sẽ kinh hãi khiếp sợ Ngài.
[SECTION] Xin Thiên Chúa thứ tha
...
như đã thề với tổ phụ chúng con từ thuở trước.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;