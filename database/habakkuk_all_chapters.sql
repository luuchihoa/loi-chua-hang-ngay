...
nên chỉ còn thứ công lý vạy vò.
[SECTION] Sấm ngôn đầu tiên: Dân Can-đê, một tai họa ĐỨC CHÚA gửi đến
...
[SECTION] Lời phàn nàn thứ hai của ngôn sứ: Kẻ áp bức đòi tiền hối lộ
...
chẳng một chút xót thương.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hb', 2, '[SECTION] Sấm ngôn thứ hai: Người công chính sẽ được sống nhờ lòng thành tín
(1) Tôi sẽ ra đứng ở chòi canh, đứng gác trên tường lũy
...
để làm tổ cho mình trên cao hầu thoát khỏi tai họa.
(10) Như thế là ngươi đã quyết định điều ô nhục cho nhà mình,
ngươi tiêu hủy nhiều dân nên thành người đắc tội,
...
(19) Khốn thay kẻ nói với khúc gỗ: “Trỗi dậy đi!”
...
toàn thể cõi đất, hãy thinh lặng trước nhan Người!') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'hb', 3, '[PART] III. CẦU XIN ĐỨC CHÚA CAN THIỆP
...
và dẫn tôi đi trên đỉnh núi cao vời.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;