...
(2) ĐỨC CHÚA là Thiên Chúa ghen tuông và báo oán,
...
(7) ĐỨC CHÚA thật tốt lành, chính Người là thành lũy chở che
...
[SECTION] Lời sấm về Giu-đa và Ni-ni-vê
[PART] (Về Giu-đa)
...
Ta sẽ khiến phần mộ ngươi nên đồ ô nhục.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'nh', 2, '[PART] (Về Giu-đa)
...
[SECTION] Bản án cho con sư tử Át-sua
...
chẳng ai thèm nghe tiếng các sứ giả của ngươi.') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;

INSERT INTO chapters (translation_id, book_id, chapter, content) VALUES (1, 'nh', 3, '[SECTION] Bản án cho Ni-ni-vê đàng điếm
...
để xa lánh quân thù.
[SECTION] Ni-ni-vê chuẩn bị, nhưng vô ích
...
Quả thật, có ai không bị ngươi làm khổ?') ON CONFLICT (translation_id, book_id, chapter) DO UPDATE SET content = EXCLUDED.content;