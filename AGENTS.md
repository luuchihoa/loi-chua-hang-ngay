...
- R2 dùng `readings/r1.mp3`, `readings/r2.mp3`, `readings/<ref>.mp3`, `gospels/<ref>.mp3`; production phát qua `workers/audio-gateway`, không suy URL R2 public. Quy tắc chi tiết ở `docs/AUDIO_FILE_NAMING.md`.
